...
int MAX_OF_FIRST_INTERVAL = 6;
// 2. [6, 15) JANK_FREQ_15_FRAME
int MAX_OF_SECOND_INTERVAL = 15;
// 3. [15, 20）JANK_FREQ_20_FRAME
int MAX_OF_THIRD_INTERVAL = 20;
// 4. [20, 36) JANK_FREQ_36_FRAME
int MAX_OF_FOURTH_INTERVAL = 36;
// 5. [36, 48) JANK_FREQ_48_FRAME
int MAX_OF_FIFTH_INTERVAL = 48;
// 6. [48, 60) JANK_FREQ_60_FRAME
int MAX_OF_SIXTH_INTERVAL = 60;
// 7. [60, 120) JANK_FREQ_120_FRAME
int MAX_OF_SEVENTH_INTERVAL = 120;
// 8. [120, 180）JANK_FREQ_180_FRAME
int MAX_OF_EIGHTTH_INTERVAL = 180;
