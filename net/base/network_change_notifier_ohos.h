...
class NET_EXPORT NetworkChangeNotifierOhos : public NetworkChangeNotifier {
 public:
  ...
  std::shared_ptr<ohos::adapter::net::NetConnectionCallback>
  connectionCallback() {
 ...
 private:
  ...
  std::unique_ptr<ohos::adapter::net::NetConnectionAdapter>
      net_connection_adapter_ = nullptr;
  std::shared_ptr<ohos::adapter::net::NetConnectionCallback>
      net_connection_callback_ = nullptr;
