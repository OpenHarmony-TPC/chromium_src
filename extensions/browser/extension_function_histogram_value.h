...
enum HistogramValue {
  ...
  DELETED_SYNCFILESYSTEM_DELETEFILESYSTEM = 87,
  ...
  DELETED_SYSTEMINDICATOR_ENABLE = 130,
  EVENTS_GETRULES = 131,
  ...
  DELETED_SYSTEMINDICATOR_DISABLE = 329,
  ...
  DELETED_SYSTEMINDICATOR_SETICON = 379,
  ...
  DELETED_DEVELOPERPRIVATE_ISPROFILEMANAGED = 558,
  ...
  DELETED_AUTOFILLPRIVATE_REMOVEENTRY = 1016,
  ...
  DELETED_PASSWORDSPRIVATE_ISACCOUNTSTOREDEFAULT = 1597,
  ...
  DELETED_AUTOTESTPRIVATE_GETLACROSINFO = 1641,
  ...
  DELETED_SHAREDSTORAGEPRIVATE_GET = 1660,
  DELETED_SHAREDSTORAGEPRIVATE_SET = 1661,
  DELETED_SHAREDSTORAGEPRIVATE_REMOVE = 1662,
  ...
  DELETED_ACCESSIBILITY_PRIVATE_ISLACROSPRIMARY = 1772,
  ...
  DELETED_ACCESSIBILITY_PRIVATE_CLIPBOARDCOPYINACTIVELACROSGOOGLEDOC = 1830,
  ...
  DELETED_CHROMEOSINFOPRIVATE_ISRUNNINGONLACROS = 1884,
  ...
  PERMISSIONS_ADDHOSTACCESSREQUEST = 1890,
  PERMISSIONS_REMOVEHOSTACCESSREQUEST = 1891,
  ...
  DELETED_AUTOFILLPRIVATE_GETUSERANNOTATIONSENTRIES = 1901,
  DELETED_AUTOFILLPRIVATE_DELETEUSERANNOTATIONSENTRY = 1902,
  DELETED_AUTOFILLPRIVATE_DELETEALLUSERANNOTATIONSENTRIES = 1903,
  ...
  AUTOTESTPRIVATE_OVERRIDESCANNERRESPONSESFORTESTING = 1923,
  AUTOFILLPRIVATE_LOADENTITYINSTANCES = 1924,
  AUTOFILLPRIVATE_ADDORUPDATEENTITYINSTANCE = 1925,
  AUTOFILLPRIVATE_REMOVEENTITYINSTANCE = 1926,
  ACCESSIBILITY_PRIVATE_ENABLELIVECAPTION = 1927,
  AUTOFILLPRIVATE_GETWRITABLEENTITYTYPES = 1928,
  AUTOFILLPRIVATE_GETALLATTRIBUTETYPESFORENTITYTYPENAME = 1929,
  AUTOFILLPRIVATE_GETENTITYINSTANCEBYGUID = 1930,
  ...
  BOOKMARKMANAGERPRIVATE_ISACTIVETABINSPLIT = 1939,
  ENTERPRISE_LOGIN_EXITCURRENTMANAGEDGUESTSESSION = 1940,
  PASSWORDSPRIVATE_SHOULDSHOWACCOUNTSTORAGESETTINGTOGGLE = 1941,
  EXPERIMENTALACTOR_PERFORMACTIONS = 1942,
  EXPERIMENTALACTOR_CREATETASK = 1943,
  ...
  AUTOFILLPRIVATE_GETWALLETABLEPASSDETECTIONOPTINSTATUS = 1951,
  AUTOFILLPRIVATE_SETWALLETABLEPASSDETECTIONOPTINSTATUS = 1952,
  METRICSPRIVATE_RECORDEXTENSIONUSAGEUKM = 1953,
  DEVELOPERPRIVATE_OPENURL = 1954,
