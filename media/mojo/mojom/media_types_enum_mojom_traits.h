  ...
  static media::mojom::DemuxerType ToMojom(::media::DemuxerType input) {
    switch (input) {
      ...
      case ::media::DemuxerType::kOhosMediaPlayerDemuxer:
        return media::mojom::DemuxerType::kOhosMediaPlayerDemuxer;
    ...
    switch (input) {
      ...
      case media::mojom::DemuxerType::kManifestDemuxer:
        *output = ::media::DemuxerType::kManifestDemuxer;
        return true;
#if BUILDFLAG(ARKWEB_CUSTOM_VIDEO_PLAYER)
      case media::mojom::DemuxerType::kOhosMediaPlayerDemuxer:
        *output = ::media::DemuxerType::kOhosMediaPlayerDemuxer;
#endif // ARKWEB_CUSTOM_VIDEO_PLAYER
        return true;
    }
