...
static NativeWindowOperation nativeWindowGetInt32Ops[] = {
    GET_FORMAT,  GET_USAGE,       GET_STRIDE,    GET_SWAP_INTERVAL,
    GET_TIMEOUT, GET_COLOR_GAMUT, GET_TRANSFORM, GET_SOURCE_TYPE};

static NativeWindowOperation nativeWindowSetInt32Ops[] = {
    SET_FORMAT,  SET_USAGE,       SET_STRIDE,    SET_SWAP_INTERVAL,
    SET_TIMEOUT, SET_COLOR_GAMUT, SET_TRANSFORM, SET_SOURCE_TYPE};
