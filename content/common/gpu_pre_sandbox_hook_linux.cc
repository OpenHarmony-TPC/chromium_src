...
static const char kLibGlesPath[] = "/vendor/lib64/chipsetsdk/libGLESv2.so";
static const char kLibEglPath[] = "/vendor/lib64/chipsetsdk/libEGL.so";
static const char kLibMaliPath[] = "/vendor/lib64/chipsetsdk/libmali.so.0";
#else
...
void AddVulkanICDPermissions(std::vector<BrokerFilePermission>* permissions) {
  ...
  static const char* const kReadOnlyICDPrefixes[] = {
