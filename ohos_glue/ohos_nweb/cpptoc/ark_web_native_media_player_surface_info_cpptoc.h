...
#ifndef ARK_WEB_NATIVE_MEDIA_PLAYER_SURFACE_INFO_CPPTOC_H_
#define ARK_WEB_NATIVE_MEDIA_PLAYER_SURFACE_INFO_CPPTOC_H_
#pragma once
...
class ArkWebNativeMediaPlayerSurfaceInfoCppToC
...
public:
  ArkWebNativeMediaPlayerSurfaceInfoCppToC();
  virtual ~ArkWebNativeMediaPlayerSurfaceInfoCppToC();
};

} // namespace OHOS::ArkWeb

#endif // ARK_WEB_NATIVE_MEDIA_PLAYER_SURFACE_INFO_CPPTOC_H_
