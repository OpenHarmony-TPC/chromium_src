...
void ARK_WEB_CALLBACK ark_web_download_manager_set_http_dns(
    struct _ark_web_download_manager_t *self, ark_web_doh_config_t *config) {
...
void ARK_WEB_CALLBACK ark_web_download_manager_set_connection_timeout(
  ...
  ARK_WEB_CPPTOC_CHECK_PARAM(timeout, );
...
template <>
ArkWebBridgeType
    ArkWebCppToCRefCounted<ArkWebDownloadManagerCppToC, ArkWebDownloadManager,
