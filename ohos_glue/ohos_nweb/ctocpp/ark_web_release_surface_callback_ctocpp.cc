...
void ArkWebReleaseSurfaceCallbackCToCpp::ReleaseSurface() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, release_surface, );

  // Execute
  _struct->release_surface(_struct);
}
...
ArkWebBridgeType ArkWebCToCppRefCounted<
    ArkWebReleaseSurfaceCallbackCToCpp, ArkWebReleaseSurfaceCallback,
