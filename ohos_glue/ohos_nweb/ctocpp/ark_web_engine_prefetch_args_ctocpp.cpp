...
ArkWebString ArkWebEnginePrefetchArgsCToCpp::GetMethod() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, get_method, ark_web_string_default);

  // Execute
  return _struct->get_method(_struct);
}
...
ArkWebString ArkWebEnginePrefetchArgsCToCpp::GetFormData() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, get_form_data,
                                   ark_web_string_default);

  // Execute
  return _struct->get_form_data(_struct);
}
...
ArkWebBridgeType ArkWebCToCppRefCounted<
    ArkWebEnginePrefetchArgsCToCpp, ArkWebEnginePrefetchArgs,
