...
void ArkWebAccessibilityEventCallbackCToCpp::OnAccessibilityEvent(
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, on_accessibility_event, );

  // Execute
  _struct->on_accessibility_event(_struct, accessibility_id, event_type);
}
...
ArkWebBridgeType ArkWebCToCppRefCounted<
    ArkWebAccessibilityEventCallbackCToCpp, ArkWebAccessibilityEventCallback,
