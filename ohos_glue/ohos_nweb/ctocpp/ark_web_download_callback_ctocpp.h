...
#ifndef ARK_WEB_DOWNLOAD_CALLBACK_CTOCPP_H_
#define ARK_WEB_DOWNLOAD_CALLBACK_CTOCPP_H_
#pragma once
...
class ArkWebDownloadCallbackCToCpp
    : public ArkWebCToCppRefCounted<ArkWebDownloadCallbackCToCpp,
                                    ArkWebDownloadCallback,
                                    ark_web_download_callback_t> {
public:
  ArkWebDownloadCallbackCToCpp();
  virtual ~ArkWebDownloadCallbackCToCpp();

  // ArkWebDownloadCallback methods.
...
#endif // ARK_WEB_DOWNLOAD_CALLBACK_CTOCPP_H_
