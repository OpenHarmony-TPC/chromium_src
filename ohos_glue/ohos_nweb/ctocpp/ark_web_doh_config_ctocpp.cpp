...
int32_t ArkWebDohConfigCToCpp::GetMode() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, get_mode, 0);

  // Execute
  return _struct->get_mode(_struct);
}
...
ArkWebString ArkWebDohConfigCToCpp::GetConfig() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, get_config, ark_web_string_default);

  // Execute
  return _struct->get_config(_struct);
}
...
template <>
ArkWebBridgeType ArkWebCToCppRefCounted<ArkWebDohConfigCToCpp, ArkWebDohConfig,
