...
#ifndef ARK_WEB_NWEB_CREATE_INFO_CTOCPP_H_
#define ARK_WEB_NWEB_CREATE_INFO_CTOCPP_H_
#pragma once
...
class ArkWebNWebCreateInfoCToCpp
    : public ArkWebCToCppRefCounted<ArkWebNWebCreateInfoCToCpp,
                                    ArkWebNWebCreateInfo,
                                    ark_web_nweb_create_info_t> {
public:
  ArkWebNWebCreateInfoCToCpp();
  virtual ~ArkWebNWebCreateInfoCToCpp();

  // ArkWebNWebCreateInfo methods.
...
#endif // ARK_WEB_NWEB_CREATE_INFO_CTOCPP_H_
