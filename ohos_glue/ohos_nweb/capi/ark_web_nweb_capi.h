...
typedef struct _ark_web_nweb_t {
  ...
  void(ARK_WEB_CALLBACK *resize)(struct _ark_web_nweb_t *self, uint32_t width,
                                 uint32_t height, bool is_keyboard);
  ...
  void(ARK_WEB_CALLBACK *on_focus)(struct _ark_web_nweb_t *self,
                                   const int32_t *focus_reason);

  void(ARK_WEB_CALLBACK *on_blur)(struct _ark_web_nweb_t *self,
                                  const int32_t *blur_reason);

  void(ARK_WEB_CALLBACK *on_touch_press)(struct _ark_web_nweb_t *self,
                                         int32_t id, double x, double y,
                                         bool from_overlay);

  void(ARK_WEB_CALLBACK *on_touch_release)(struct _ark_web_nweb_t *self,
                                           int32_t id, double x, double y,
                                           bool from_overlay);

  void(ARK_WEB_CALLBACK *on_touch_move1)(struct _ark_web_nweb_t *self,
                                         int32_t id, double x, double y,
                                         bool from_overlay);
  ...
  bool(ARK_WEB_CALLBACK *send_key_event)(struct _ark_web_nweb_t *self,
                                         int32_t key_code, int32_t key_action);

  void(ARK_WEB_CALLBACK *send_mouse_wheel_event)(struct _ark_web_nweb_t *self,
                                                 double x, double y,
                                                 double delta_x,
                                                 double delta_y);

  void(ARK_WEB_CALLBACK *send_mouse_event)(struct _ark_web_nweb_t *self, int x,
                                           int y, int button, int action,
                                           int count);

  int(ARK_WEB_CALLBACK *load1)(struct _ark_web_nweb_t *self,
                               const ArkWebString *url);

  bool(ARK_WEB_CALLBACK *is_navigatebackward_allowed)(
      struct _ark_web_nweb_t *self);

  bool(ARK_WEB_CALLBACK *is_navigate_forward_allowed)(
      struct _ark_web_nweb_t *self);

  bool(ARK_WEB_CALLBACK *can_navigate_back_or_forward)(
  ...
  void(ARK_WEB_CALLBACK *navigate_back_or_forward)(struct _ark_web_nweb_t *self,
                                                   int step);
  ...
  void(ARK_WEB_CALLBACK *execute_java_script1)(struct _ark_web_nweb_t *self,
                                               const ArkWebString *code);

  void(ARK_WEB_CALLBACK *execute_java_script2)(
      struct _ark_web_nweb_t *self, const ArkWebString *code,
      ark_web_message_value_callback_t *callback, bool extention);

  ark_web_preference_t *(ARK_WEB_CALLBACK *get_preference)(
      struct _ark_web_nweb_t *self);

  unsigned int(ARK_WEB_CALLBACK *get_web_id)(struct _ark_web_nweb_t *self);

  ark_web_hit_test_result_t *(ARK_WEB_CALLBACK *get_hit_test_result)(
      struct _ark_web_nweb_t *self);

  void(ARK_WEB_CALLBACK *put_background_color)(struct _ark_web_nweb_t *self,
                                               int color);

  void(ARK_WEB_CALLBACK *initial_scale)(struct _ark_web_nweb_t *self,
                                        float scale);
  ...
  void(ARK_WEB_CALLBACK *set_nweb_handler)(struct _ark_web_nweb_t *self,
  ...
  int(ARK_WEB_CALLBACK *load2)(struct _ark_web_nweb_t *self,
                               const ArkWebString *url,
                               const ArkWebStringMap *additional_http_headers);

  int(ARK_WEB_CALLBACK *load_with_data_and_base_url)(
  ...
  int(ARK_WEB_CALLBACK *load_with_data)(struct _ark_web_nweb_t *self,
  ...
  void(ARK_WEB_CALLBACK *put_find_callback)(
      struct _ark_web_nweb_t *self, ark_web_find_callback_t *find_listener);

  void(ARK_WEB_CALLBACK *find_all_async)(struct _ark_web_nweb_t *self,
                                         const ArkWebString *search_str);

  void(ARK_WEB_CALLBACK *clear_matches)(struct _ark_web_nweb_t *self);

  void(ARK_WEB_CALLBACK *find_next)(struct _ark_web_nweb_t *self,
                                    const bool forward);

  void(ARK_WEB_CALLBACK *store_web_archive)(
      struct _ark_web_nweb_t *self, const ArkWebString *base_name,
      bool auto_name, ark_web_string_value_callback_t *callback);

  ArkWebStringVector(ARK_WEB_CALLBACK *create_web_message_ports)(
      struct _ark_web_nweb_t *self);

  void(ARK_WEB_CALLBACK *post_web_message)(struct _ark_web_nweb_t *self,
                                           const ArkWebString *message,
                                           const ArkWebStringVector *ports,
                                           const ArkWebString *target_uri);

  void(ARK_WEB_CALLBACK *close_port)(struct _ark_web_nweb_t *self,
                                     const ArkWebString *port_handle);

  void(ARK_WEB_CALLBACK *post_port_message)(struct _ark_web_nweb_t *self,
                                            const ArkWebString *port_handle,
  ...
  void(ARK_WEB_CALLBACK *clear_client_authentication_cache)(
      struct _ark_web_nweb_t *self);

  void(ARK_WEB_CALLBACK *update_locale)(struct _ark_web_nweb_t *self,
                                        const ArkWebString *language,
                                        const ArkWebString *region);

  const ArkWebString(ARK_WEB_CALLBACK *get_original_url)(
      struct _ark_web_nweb_t *self);

  bool(ARK_WEB_CALLBACK *get_favicon)(struct _ark_web_nweb_t *self,
                                      const void **data, size_t *width,
                                      size_t *height, int *color_type,
                                      int *alpha_type);

  void(ARK_WEB_CALLBACK *put_network_available)(struct _ark_web_nweb_t *self,
                                                bool available);

  void(ARK_WEB_CALLBACK *has_images)(struct _ark_web_nweb_t *self,
                                     ark_web_bool_value_callback_t *callback);

  void(ARK_WEB_CALLBACK *remove_cache)(struct _ark_web_nweb_t *self,
                                       bool include_disk_files);

  ark_web_history_list_t *(ARK_WEB_CALLBACK *get_history_list)(
      struct _ark_web_nweb_t *self);
  ...
  ArkWebUint8Vector(ARK_WEB_CALLBACK *serialize_web_state)(
      struct _ark_web_nweb_t *self);

  bool(ARK_WEB_CALLBACK *restore_web_state)(struct _ark_web_nweb_t *self,
  ...
  void(ARK_WEB_CALLBACK *scroll_to)(struct _ark_web_nweb_t *self, float x,
                                    float y);

  void(ARK_WEB_CALLBACK *scroll_by)(struct _ark_web_nweb_t *self, float delta_x,
                                    float delta_y);

  void(ARK_WEB_CALLBACK *slide_scroll)(struct _ark_web_nweb_t *self, float vx,
                                       float vy);
  ...
  void(ARK_WEB_CALLBACK *set_screen_off_set)(struct _ark_web_nweb_t *self,
                                             double x, double y);

  void(ARK_WEB_CALLBACK *set_audio_muted)(struct _ark_web_nweb_t *self,
                                          bool muted);

  void(ARK_WEB_CALLBACK *set_should_frame_submission_before_draw)(
      struct _ark_web_nweb_t *self, bool should);

  void(ARK_WEB_CALLBACK *notify_popup_window_result)(
      struct _ark_web_nweb_t *self, bool result);

  void(ARK_WEB_CALLBACK *set_audio_resume_interval)(
      struct _ark_web_nweb_t *self, int32_t resume_interval);

  void(ARK_WEB_CALLBACK *set_audio_exclusive)(struct _ark_web_nweb_t *self,
  ...
  void(ARK_WEB_CALLBACK *un_register_screen_lock_function)(
      struct _ark_web_nweb_t *self, int32_t window_id);

  void(ARK_WEB_CALLBACK *notify_memory_level)(struct _ark_web_nweb_t *self,
                                              int32_t level);
  ...
  ark_web_drag_data_t *(ARK_WEB_CALLBACK *get_or_create_drag_data)(
      struct _ark_web_nweb_t *self);
  ...
  void(ARK_WEB_CALLBACK *set_window_id)(struct _ark_web_nweb_t *self,
                                        uint32_t window_id);
  ...
  void(ARK_WEB_CALLBACK *set_nested_scroll_mode)(
      struct _ark_web_nweb_t *self, const int32_t *nested_scroll_mode);

  void(ARK_WEB_CALLBACK *set_enable_lower_frame_rate)(
  ...
  bool(ARK_WEB_CALLBACK *should_virtual_keyboard_overlay)(
      struct _ark_web_nweb_t *self);

  void(ARK_WEB_CALLBACK *set_draw_rect)(struct _ark_web_nweb_t *self, int32_t x,
                                        int32_t y, int32_t width,
                                        int32_t height);

  void(ARK_WEB_CALLBACK *set_draw_mode)(struct _ark_web_nweb_t *self,
                                        int32_t mode);

  void *(ARK_WEB_CALLBACK *create_web_print_document_adapter)(
      struct _ark_web_nweb_t *self, const ArkWebString *job_name);

  int(ARK_WEB_CALLBACK *post_url)(struct _ark_web_nweb_t *self,
                                  const ArkWebString *url,
  ...
  void(ARK_WEB_CALLBACK *execute_action)(struct _ark_web_nweb_t *self,
                                         int64_t accessibility_id,
                                         uint32_t action);

  ark_web_accessibility_node_info_t *(
      ARK_WEB_CALLBACK *get_focused_accessibility_node_info)(
      struct _ark_web_nweb_t *self, int64_t accessibility_id,
      bool is_accessibility_focus);

  ark_web_accessibility_node_info_t *(
      ARK_WEB_CALLBACK *get_accessibility_node_info_by_id)(
      struct _ark_web_nweb_t *self, int64_t accessibility_id);

  ark_web_accessibility_node_info_t *(
      ARK_WEB_CALLBACK *get_accessibility_node_info_by_focus_move)(
      struct _ark_web_nweb_t *self, int64_t accessibility_id,
      int32_t direction);

  void(ARK_WEB_CALLBACK *set_accessibility_state)(struct _ark_web_nweb_t *self,
                                                  bool state);
  ...
  void(ARK_WEB_CALLBACK *call_h5function)(struct _ark_web_nweb_t *self,
                                          int32_t routingId, int32_t h5ObjectId,
  ...
  void(ARK_WEB_CALLBACK *un_register_native_ark_jsfunction)(
      struct _ark_web_nweb_t *self, const char *objName);
  ...
  void(ARK_WEB_CALLBACK *enable_safe_browsing)(struct _ark_web_nweb_t *self,
                                               bool enable);

  bool(ARK_WEB_CALLBACK *is_safe_browsing_enabled)(
      struct _ark_web_nweb_t *self);

  void(ARK_WEB_CALLBACK *set_print_background)(struct _ark_web_nweb_t *self,
                                               bool enable);
