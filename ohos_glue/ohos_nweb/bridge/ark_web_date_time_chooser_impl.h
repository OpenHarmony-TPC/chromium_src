...
#ifndef ARK_WEB_DATE_TIME_CHOOSER_IMPL_H_
#define ARK_WEB_DATE_TIME_CHOOSER_IMPL_H_
#pragma once
...
class ArkWebDateTimeChooserImpl : public ArkWebDateTimeChooser {
  IMPLEMENT_REFCOUNTING(ArkWebDateTimeChooserImpl);

public:
  ArkWebDateTimeChooserImpl(
      std::shared_ptr<OHOS::NWeb::NWebDateTimeChooser> nweb_date_time_chooser);
  ~ArkWebDateTimeChooserImpl() = default;
...
private:
  std::shared_ptr<OHOS::NWeb::NWebDateTimeChooser> nweb_date_time_chooser_;
};

} // namespace OHOS::ArkWeb

#endif // ARK_WEB_DATE_TIME_CHOOSER_H_
