...
ArkWebFileSelectorParamsImpl::ArkWebFileSelectorParamsImpl(
    std::shared_ptr<OHOS::NWeb::NWebFileSelectorParams>
        nweb_file_selector_params)
