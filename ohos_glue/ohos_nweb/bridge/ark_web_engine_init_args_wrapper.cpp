...
ArkWebEngineInitArgsWrapper::ArkWebEngineInitArgsWrapper(
...
std::list<std::string> ArkWebEngineInitArgsWrapper::GetArgsToAdd() {
  ...
  std::list<std::string> objArgsToAdd =
      ArkWebStringListStructToClass(stArgsToAdd);
  ArkWebStringListStructRelease(stArgsToAdd);
  return objArgsToAdd;
}

std::list<std::string> ArkWebEngineInitArgsWrapper::GetArgsToDelete() {
  ArkWebStringList stArgsToDelete =
      ark_web_engine_init_args_->GetArgsToDelete();

  std::list<std::string> objArgsToDelete =
      ArkWebStringListStructToClass(stArgsToDelete);
