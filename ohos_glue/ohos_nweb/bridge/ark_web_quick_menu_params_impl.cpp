...
ArkWebRefPtr<ArkWebTouchHandleState>
ArkWebQuickMenuParamsImpl::GetTouchHandleState(int type) {
  std::shared_ptr<OHOS::NWeb::NWebTouchHandleState> nweb_touch_handle_state =
      nweb_quick_menu_params_->GetTouchHandleState(
          static_cast<ArkWebTouchHandleType>(type));
