...
#ifndef ARK_WEB_MESSAGE_VALUE_CALLBACK_WRAPPER_H_
#define ARK_WEB_MESSAGE_VALUE_CALLBACK_WRAPPER_H_
#pragma once
...
class ArkWebMessageValueCallbackWrapper
    : public OHOS::NWeb::NWebMessageValueCallback {
public:
  ArkWebMessageValueCallbackWrapper(
      ArkWebRefPtr<ArkWebMessageValueCallback> ark_web_message_value_callback);
  ~ArkWebMessageValueCallbackWrapper() = default;
...
#endif // ARK_WEB_MESSAGE_VALUE_CALLBACK_WRAPPER_H_
