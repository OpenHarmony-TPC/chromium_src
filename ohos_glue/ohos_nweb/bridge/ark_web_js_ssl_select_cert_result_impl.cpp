...
ArkWebJsSslSelectCertResultImpl::ArkWebJsSslSelectCertResultImpl(
    std::shared_ptr<OHOS::NWeb::NWebJSSslSelectCertResult>
        nweb_js_ssl_select_cert_result)
...
void ArkWebJsSslSelectCertResultImpl::Confirm(
    const ArkWebString &private_key_file, const ArkWebString &cert_chain_file) {
  nweb_js_ssl_select_cert_result_->Confirm(
      ArkWebStringStructToClass(private_key_file),
      ArkWebStringStructToClass(cert_chain_file));
}
