...
#ifndef ARK_WEB_SELECT_POPUP_MENU_PARAM_IMPL_H_
#define ARK_WEB_SELECT_POPUP_MENU_PARAM_IMPL_H_
#pragma once
...
class ArkWebSelectPopupMenuParamImpl : public ArkWebSelectPopupMenuParam {
  IMPLEMENT_REFCOUNTING(ArkWebSelectPopupMenuParamImpl);

public:
  ArkWebSelectPopupMenuParamImpl(
      std::shared_ptr<OHOS::NWeb::NWebSelectPopupMenuParam>
          nweb_select_popup_menu_param);
  ~ArkWebSelectPopupMenuParamImpl() = default;
...
private:
  std::shared_ptr<OHOS::NWeb::NWebSelectPopupMenuParam>
      nweb_select_popup_menu_param_;
};

} // namespace OHOS::ArkWeb

#endif // ARK_WEB_SELECT_POPUP_MENU_PARAM_IMPL_H_
