...
ArkWebUint32Vector ArkWebAccessibilityNodeInfoImpl::GetActions() {
  return ArkWebBasicVectorClassToStruct<uint32_t, ArkWebUint32Vector>(
      nweb_accessibility_node_info_->GetActions());
}
...
ArkWebInt64Vector ArkWebAccessibilityNodeInfoImpl::GetChildIds() {
  return ArkWebBasicVectorClassToStruct<int64_t, ArkWebInt64Vector>(
      nweb_accessibility_node_info_->GetChildIds());
}
...
ArkWebString ArkWebAccessibilityNodeInfoImpl::GetComponentType() {
  return ArkWebStringClassToStruct(
      nweb_accessibility_node_info_->GetComponentType());
}

ArkWebString ArkWebAccessibilityNodeInfoImpl::GetDescriptionInfo() {
  return ArkWebStringClassToStruct(
      nweb_accessibility_node_info_->GetDescriptionInfo());
}
