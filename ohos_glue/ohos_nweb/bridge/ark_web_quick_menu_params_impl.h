...
#ifndef ARK_WEB_QUICK_MENU_PARAMS_IMPL_H_
#define ARK_WEB_QUICK_MENU_PARAMS_IMPL_H_
#pragma once
...
class ArkWebQuickMenuParamsImpl : public ArkWebQuickMenuParams {
  IMPLEMENT_REFCOUNTING(ArkWebQuickMenuParamsImpl);

public:
  ArkWebQuickMenuParamsImpl(
      std::shared_ptr<OHOS::NWeb::NWebQuickMenuParams> nweb_quick_menu_params);
  ~ArkWebQuickMenuParamsImpl() = default;
...
#endif // ARK_WEB_QUICK_MENU_PARAMS_IMPL_H_
