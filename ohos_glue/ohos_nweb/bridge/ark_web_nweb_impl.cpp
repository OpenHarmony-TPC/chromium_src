...
ArkWebNWebImpl::ArkWebNWebImpl(std::shared_ptr<OHOS::NWeb::NWeb> nweb_nweb)
    : nweb_nweb_(nweb_nweb) {
}
...
void ArkWebNWebImpl::OnTouchPress(int32_t id, double x, double y,
                                  bool from_overlay) {
  nweb_nweb_->OnTouchPress(id, x, y, from_overlay);
}

void ArkWebNWebImpl::OnTouchRelease(int32_t id, double x, double y,
                                    bool from_overlay) {
  nweb_nweb_->OnTouchRelease(id, x, y, from_overlay);
}

void ArkWebNWebImpl::OnTouchMove(int32_t id, double x, double y,
                                 bool from_overlay) {
  nweb_nweb_->OnTouchMove(id, x, y, from_overlay);
}

void ArkWebNWebImpl::OnTouchMove(
    const ArkWebTouchPointInfoVector &touch_point_infos, bool from_overlay) {
  nweb_nweb_->OnTouchMove(
      ArkWebTouchPointInfoVectorStructToClass(touch_point_infos), from_overlay);
}
...
void ArkWebNWebImpl::SendMouseWheelEvent(double x, double y, double delta_x,
                                         double delta_y) {
  nweb_nweb_->SendMouseWheelEvent(x, y, delta_x, delta_y);
}

void ArkWebNWebImpl::SendMouseEvent(int x, int y, int button, int action,
                                    int count) {
...
void ArkWebNWebImpl::ExecuteJavaScript(
    const ArkWebString &code, ArkWebRefPtr<ArkWebMessageValueCallback> callback,
    bool extention) {
  if (CHECK_REF_PTR_IS_NULL(callback)) {
    nweb_nweb_->ExecuteJavaScript(ArkWebStringStructToClass(code), nullptr,
                                  extention);
    return;
  }

  nweb_nweb_->ExecuteJavaScript(
      ArkWebStringStructToClass(code),
...
ArkWebRefPtr<ArkWebPreference> ArkWebNWebImpl::GetPreference() {
  std::shared_ptr<OHOS::NWeb::NWebPreference> nweb_preference =
      nweb_nweb_->GetPreference();
...
void ArkWebNWebImpl::PutDownloadCallback(
    ArkWebRefPtr<ArkWebDownloadCallback> download_listener) {
  if (CHECK_REF_PTR_IS_NULL(download_listener)) {
    nweb_nweb_->PutDownloadCallback(nullptr);
    return;
  }

  nweb_nweb_->PutDownloadCallback(
      std::make_shared<ArkWebDownloadCallbackWrapper>(download_listener));
}
...
void ArkWebNWebImpl::PutAccessibilityEventCallback(
  ...
  nweb_nweb_->PutAccessibilityEventCallback(
      std::make_shared<ArkWebAccessibilityEventCallbackWrapper>(
          accessibility_event_listener));
}

void ArkWebNWebImpl::PutAccessibilityIdGenerator(
    AccessibilityIdGenerateFunc accessibility_id_generator) {
...
int ArkWebNWebImpl::Load(const ArkWebString &url,
  ...
  return nweb_nweb_->Load(
      ArkWebStringStructToClass(url),
      ArkWebStringMapStructToClass(additional_http_headers));
}

int ArkWebNWebImpl::LoadWithDataAndBaseUrl(const ArkWebString &base_url,
                                           const ArkWebString &data,
                                           const ArkWebString &mime_type,
                                           const ArkWebString &encoding,
                                           const ArkWebString &history_url) {
  return nweb_nweb_->LoadWithDataAndBaseUrl(
      ArkWebStringStructToClass(base_url), ArkWebStringStructToClass(data),
      ArkWebStringStructToClass(mime_type), ArkWebStringStructToClass(encoding),
      ArkWebStringStructToClass(history_url));
}

int ArkWebNWebImpl::LoadWithData(const ArkWebString &data,
                                 const ArkWebString &mime_type,
                                 const ArkWebString &encoding) {
  return nweb_nweb_->LoadWithData(ArkWebStringStructToClass(data),
...
void ArkWebNWebImpl::RegisterArkJSfunction(
  ...
  nweb_nweb_->RegisterArkJSfunction(
      ...
      ArkWebStringVectorStructToClass(method_list), object_id);
}

void ArkWebNWebImpl::UnregisterArkJSfunction(
    const ArkWebString &object_name, const ArkWebStringVector &method_list) {
...
void ArkWebNWebImpl::SetNWebJavaScriptResultCallBack(
    ArkWebRefPtr<ArkWebJsResultCallback> callback) {
  if (CHECK_REF_PTR_IS_NULL(callback)) {
    nweb_nweb_->SetNWebJavaScriptResultCallBack(nullptr);
    return;
  }

  nweb_nweb_->SetNWebJavaScriptResultCallBack(
      std::make_shared<ArkWebJsResultCallbackWrapper>(callback));
}

void ArkWebNWebImpl::PutFindCallback(
    ArkWebRefPtr<ArkWebFindCallback> find_listener) {
  if (CHECK_REF_PTR_IS_NULL(find_listener)) {
    nweb_nweb_->PutFindCallback(nullptr);
    return;
  }

  nweb_nweb_->PutFindCallback(
      std::make_shared<ArkWebFindCallbackWrapper>(find_listener));
}
...
void ArkWebNWebImpl::StoreWebArchive(
    const ArkWebString &base_name, bool auto_name,
    ArkWebRefPtr<ArkWebStringValueCallback> callback) {
  if (CHECK_REF_PTR_IS_NULL(callback)) {
    nweb_nweb_->StoreWebArchive(ArkWebStringStructToClass(base_name), auto_name,
                                nullptr);
    return;
  }

  nweb_nweb_->StoreWebArchive(
      ArkWebStringStructToClass(base_name), auto_name,
...
void ArkWebNWebImpl::PostWebMessage(const ArkWebString &message,
                                    const ArkWebStringVector &ports,
                                    const ArkWebString &target_uri) {
  nweb_nweb_->PostWebMessage(ArkWebStringStructToClass(message),
                             ArkWebStringVectorStructToClass(ports),
...
void ArkWebNWebImpl::PostPortMessage(const ArkWebString &port_handle,
                                     const ArkWebMessage &data) {
  nweb_nweb_->PostPortMessage(ArkWebStringStructToClass(port_handle),
                              data.nweb_message);
}
...
void ArkWebNWebImpl::SetPortMessageCallback(
  ...
  if (CHECK_REF_PTR_IS_NULL(callback)) {
    nweb_nweb_->SetPortMessageCallback(ArkWebStringStructToClass(port_handle),
                                       nullptr);
    return;
  }

  nweb_nweb_->SetPortMessageCallback(
      ArkWebStringStructToClass(port_handle),
...
void ArkWebNWebImpl::UpdateLocale(const ArkWebString &language,
                                  const ArkWebString &region) {
  nweb_nweb_->UpdateLocale(ArkWebStringStructToClass(language),
                           ArkWebStringStructToClass(region));
}
...
bool ArkWebNWebImpl::GetFavicon(const void **data, size_t &width,
  ...
  bool result = nweb_nweb_->GetFavicon(data, width, height, enum_color_type,
                                       enum_alpha_type);
...
void ArkWebNWebImpl::PutReleaseSurfaceCallback(
    ArkWebRefPtr<ArkWebReleaseSurfaceCallback> release_surface_listener) {
  ...
  nweb_nweb_->PutReleaseSurfaceCallback(
      std::make_shared<ArkWebReleaseSurfaceCallbackWrapper>(
          release_surface_listener));
}

ArkWebUint8Vector ArkWebNWebImpl::SerializeWebState() {
  return ArkWebBasicVectorClassToStruct<uint8_t, ArkWebUint8Vector>(
      nweb_nweb_->SerializeWebState());
}

bool ArkWebNWebImpl::RestoreWebState(const ArkWebUint8Vector &state) {
  return nweb_nweb_->RestoreWebState(
      ArkWebBasicVectorStructToClass<uint8_t, ArkWebUint8Vector>(state));
}
...
bool ArkWebNWebImpl::GetCertChainDerData(ArkWebStringVector &cert_chain_data,
                                         bool is_single_cert) {
  std::vector<std::string> cert_chain_data_vector;
  bool result =
      nweb_nweb_->GetCertChainDerData(cert_chain_data_vector, is_single_cert);
...
void ArkWebNWebImpl::RegisterScreenLockFunction(
    int32_t window_id, ArkWebRefPtr<ArkWebScreenLockCallback> callback) {
  if (CHECK_REF_PTR_IS_NULL(callback)) {
    nweb_nweb_->RegisterScreenLockFunction(window_id, nullptr);
    return;
  }

  nweb_nweb_->RegisterScreenLockFunction(
      window_id, std::make_shared<ArkWebScreenLockCallbackWrapper>(callback));
}
...
ArkWebRefPtr<ArkWebDragData> ArkWebNWebImpl::GetOrCreateDragData() {
  std::shared_ptr<OHOS::NWeb::NWebDragData> nweb_drag_data =
      nweb_nweb_->GetOrCreateDragData();
...
void ArkWebNWebImpl::PrefetchPage(
    const ArkWebString &url, const ArkWebStringMap &additional_http_headers) {
  nweb_nweb_->PrefetchPage(
      ArkWebStringStructToClass(url),
      ArkWebStringMapStructToClass(additional_http_headers));
}
...
void ArkWebNWebImpl::SetNestedScrollMode(const int32_t &nested_scroll_mode) {
  nweb_nweb_->SetNestedScrollMode(
      static_cast<ArkWebNestedScrollMode>(nested_scroll_mode));
}
...
void ArkWebNWebImpl::SetVirtualKeyBoardArg(int32_t width, int32_t height,
                                           double keyboard) {
...
void ArkWebNWebImpl::SetDrawRect(int32_t x, int32_t y, int32_t width,
                                 int32_t height) {
...
void *
ArkWebNWebImpl::CreateWebPrintDocumentAdapter(const ArkWebString &job_name) {
  return nweb_nweb_->CreateWebPrintDocumentAdapter(
      ArkWebStringStructToClass(job_name));
}

int ArkWebNWebImpl::PostUrl(const ArkWebString &url,
                            const ArkWebCharVector &post_data) {
  return nweb_nweb_->PostUrl(
      ArkWebStringStructToClass(url),
      ArkWebBasicVectorStructToClass<char, ArkWebCharVector>(post_data));
}

void ArkWebNWebImpl::JavaScriptOnDocumentStart(
    const ArkWebStringVectorMap &script_items) {
  nweb_nweb_->JavaScriptOnDocumentStart(
      ArkWebStringVectorMapStructToClass(script_items));
}
...
ArkWebRefPtr<ArkWebAccessibilityNodeInfo>
ArkWebNWebImpl::GetFocusedAccessibilityNodeInfo(int64_t accessibility_id,
                                                bool is_accessibility_focus) {
  std::shared_ptr<OHOS::NWeb::NWebAccessibilityNodeInfo>
      nweb_accessibility_node_info =
          nweb_nweb_->GetFocusedAccessibilityNodeInfo(accessibility_id,
...
ArkWebRefPtr<ArkWebAccessibilityNodeInfo>
ArkWebNWebImpl::GetAccessibilityNodeInfoById(int64_t accessibility_id) {
  std::shared_ptr<OHOS::NWeb::NWebAccessibilityNodeInfo>
      nweb_accessibility_node_info =
...
ArkWebRefPtr<ArkWebAccessibilityNodeInfo>
ArkWebNWebImpl::GetAccessibilityNodeInfoByFocusMove(int64_t accessibility_id,
                                                    int32_t direction) {
  std::shared_ptr<OHOS::NWeb::NWebAccessibilityNodeInfo>
      nweb_accessibility_node_info =
          nweb_nweb_->GetAccessibilityNodeInfoByFocusMove(accessibility_id,
                                                          direction);
  if (CHECK_SHARED_PTR_IS_NULL(nweb_accessibility_node_info)) {
    return nullptr;
  }
...
void ArkWebNWebImpl::CallH5Function(int32_t routingId, int32_t h5ObjectId,
                                    const ArkWebString &h5MethodName,
                                    const ArkWebValueVector &args) {
  nweb_nweb_->CallH5Function(routingId, h5ObjectId,
                             ArkWebStringStructToClass(h5MethodName),
                             ArkWebValueVectorStructToClass(args));
}
...
void ArkWebNWebImpl::RegisterNativeArkJSFunction(
    const char *objName, const ArkWebJsProxyCallbackVector &callbacks) {
  nweb_nweb_->RegisterNativeArkJSFunction(
      objName, ArkWebJsProxyCallbackVectorStructToClass(callbacks));
}
...
void ArkWebNWebImpl::RegisterNativeValideCallback(
    const char *webName, const NativeArkWebOnValidCallback callback) {
  nweb_nweb_->RegisterNativeValideCallback(webName, callback);
}

void ArkWebNWebImpl::RegisterNativeDestroyCallback(
    const char *webName, const NativeArkWebOnValidCallback callback) {
  nweb_nweb_->RegisterNativeDestroyCallback(webName, callback);
}

void ArkWebNWebImpl::JavaScriptOnDocumentEnd(
    const ArkWebStringVectorMap &script_items) {
  nweb_nweb_->JavaScriptOnDocumentEnd(
      ArkWebStringVectorMapStructToClass(script_items));
}
...
void ArkWebNWebImpl::DragResize(uint32_t width, uint32_t height,
                                uint32_t pre_height, uint32_t pre_width) {
...
int ArkWebNWebImpl::ScaleGestureChange(double scale, double centerX,
                                       double centerY) {
