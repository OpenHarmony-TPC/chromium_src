...
ArkWebDragDataImpl::ArkWebDragDataImpl(
...
bool ArkWebDragDataImpl::GetPixelMapSetting(const void **data, size_t &len,
                                            int &width, int &height) {
  return nweb_drag_data_->GetPixelMapSetting(data, len, width, height);
}

bool ArkWebDragDataImpl::SetPixelMapSetting(const void *data, size_t len,
                                            int width, int height) {
