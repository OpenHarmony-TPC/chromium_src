...
ArkWebPreferenceImpl::ArkWebPreferenceImpl(
...
void ArkWebPreferenceImpl::PutSansSerifFontFamilyName(
...
ArkWebString ArkWebPreferenceImpl::DefaultTextEncodingFormat() {
  return ArkWebStringClassToStruct(
      nweb_preference_->DefaultTextEncodingFormat());
}

void ArkWebPreferenceImpl::PutDefaultTextEncodingFormat(
    const ArkWebString &encoding) {
  nweb_preference_->PutDefaultTextEncodingFormat(
...
int ArkWebPreferenceImpl::AccessModeForSecureOriginLoadFromInsecure() {
  return static_cast<int>(
      nweb_preference_->AccessModeForSecureOriginLoadFromInsecure());
}

void ArkWebPreferenceImpl::PutAccessModeForSecureOriginLoadFromInsecure(
    int mode) {
  nweb_preference_->PutAccessModeForSecureOriginLoadFromInsecure(
      static_cast<ArkWebAccessMode>(mode));
}
...
void ArkWebPreferenceImpl::PutCopyOptionMode(int copyOption) {
  nweb_preference_->PutCopyOptionMode(
      static_cast<ArkWebCopyOptionMode>(copyOption));
}
