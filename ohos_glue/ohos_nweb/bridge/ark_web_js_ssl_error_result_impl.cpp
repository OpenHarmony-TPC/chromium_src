...
ArkWebJsSslErrorResultImpl::ArkWebJsSslErrorResultImpl(
    std::shared_ptr<OHOS::NWeb::NWebJSSslErrorResult> nweb_js_ssl_error_result)
    : nweb_js_ssl_error_result_(nweb_js_ssl_error_result) {
}

void ArkWebJsSslErrorResultImpl::HandleCancel() {
  nweb_js_ssl_error_result_->HandleCancel();
}
