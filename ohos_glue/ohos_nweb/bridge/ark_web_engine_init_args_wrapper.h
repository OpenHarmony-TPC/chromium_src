...
#ifndef ARK_WEB_ENGINE_INIT_ARGS_WRAPPER_H_
#define ARK_WEB_ENGINE_INIT_ARGS_WRAPPER_H_
#pragma once
...
class ArkWebEngineInitArgsWrapper : public OHOS::NWeb::NWebEngineInitArgs {
public:
  ArkWebEngineInitArgsWrapper(
      ArkWebRefPtr<ArkWebEngineInitArgs> ark_web_engine_init_args);
  ~ArkWebEngineInitArgsWrapper() = default;
...
#endif // ARK_WEB_ENGINE_INIT_ARGS_WRAPPER_H_
