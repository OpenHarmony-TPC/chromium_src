...
public:
   ...
   */
  /*--ark web()--*/
  virtual void OnPageIcon(const void *data, size_t width, size_t height,
                          int color_type, int alpha_type) = 0;
  ...
  OnHttpError(ArkWebRefPtr<ArkWebUrlResourceRequest> request,
              ArkWebRefPtr<ArkWebUrlResourceResponse> error_response) = 0;
   ...
   */
  /*--ark web()--*/
  virtual void OnPageLoadError(int error_code, const ArkWebString &description,
                               const ArkWebString &failing_url) = 0;
   ...
   */
  /*--ark web()--*/
  virtual void OnDesktopIconUrl(const ArkWebString &icon_url,
                                bool precomposed) = 0;
  ...
  OnGeolocationShow(const ArkWebString &origin,
                    ArkWebRefPtr<ArkWebGeoLocationCallback> callback) = 0;
  ...
  OnFileSelectorShow(ArkWebRefPtr<ArkWebStringVectorValueCallback> callback,
                     ArkWebRefPtr<ArkWebFileSelectorParams> params) = 0;
  ...
  /*--ark web()--*/
  virtual void
  OnResourceLoadError(ArkWebRefPtr<ArkWebUrlResourceRequest> request,
  ...
  /*--ark web()--*/
  virtual void
  OnPermissionRequest(ArkWebRefPtr<ArkWebAccessRequest> request) = 0;
  ...
  virtual bool OnHandleInterceptRequest(
      ...
      ArkWebRefPtr<ArkWebUrlResourceResponse> response) = 0;
   ...
   */
  /*--ark web()--*/
  virtual void OnRefreshAccessedHistory(const ArkWebString &url,
                                        bool is_reload) = 0;
  ...
  /*--ark web()--*/
  virtual void
  OnPermissionRequestCanceled(ArkWebRefPtr<ArkWebAccessRequest> request) = 0;
   ...
   */
  /*--ark web()--*/
  virtual bool OnHandleInterceptUrlLoading(
      ArkWebRefPtr<ArkWebUrlResourceRequest> request) = 0;

  /*--ark web()--*/
  virtual bool RunQuickMenu(ArkWebRefPtr<ArkWebQuickMenuParams> params,
                            ArkWebRefPtr<ArkWebQuickMenuCallback> callback) = 0;

  /*--ark web()--*/
  virtual bool
  RunContextMenu(ArkWebRefPtr<ArkWebContextMenuParams> params,
                 ArkWebRefPtr<ArkWebContextMenuCallback> callback) = 0;

  /*--ark web()--*/
  virtual void UpdateDragCursor(unsigned char op) = 0;

  /*--ark web()--*/
  virtual bool FilterScrollEvent(const float x, const float y,
                                 const float x_velocity,
                                 const float y_velocity) = 0;
  ...
  /*--ark web()--*/
  virtual void
  OnWindowNewByJS(const ArkWebString &target_url, bool is_alert,
   ...
   */
  /*--ark web()--*/
  virtual bool OnAlertDialogByJS(const ArkWebString &url,
  ...
  /*--ark web()--*/
  virtual bool
  OnBeforeUnloadByJS(const ArkWebString &url, const ArkWebString &message,
                     ArkWebRefPtr<ArkWebJsDialogResult> result) = 0;
  ...
  /*--ark web()--*/
  virtual bool
  OnPromptDialogByJS(const ArkWebString &url, const ArkWebString &message,
  ...
  /*--ark web()--*/
  virtual bool
  OnConfirmDialogByJS(const ArkWebString &url, const ArkWebString &message,
                      ArkWebRefPtr<ArkWebJsDialogResult> result) = 0;

  /*--ark web()--*/
  virtual bool
  OnHttpAuthRequestByJS(ArkWebRefPtr<ArkWebJsHttpAuthResult> result,
                        const ArkWebString &host,
                        const ArkWebString &realm) = 0;

  /*--ark web()--*/
  virtual bool
  OnSslErrorRequestByJS(ArkWebRefPtr<ArkWebJsSslErrorResult> result,
                        int error) = 0;
  ...
  OnSslSelectCertRequestByJS(ArkWebRefPtr<ArkWebJsSslSelectCertResult> result,
                             ...
                             const ArkWebStringVector &issuers) = 0;
  ...
  /*--ark web()--*/
  virtual void OnScaleChanged(float old_scale_factor,
  ...
  /*--ark web()--*/
  virtual void
  OnFullScreenEnter(ArkWebRefPtr<ArkWebFullScreenExitHandler> handler) = 0;
  ...
  /*--ark web()--*/
  virtual void
  OnSelectPopupMenu(ArkWebRefPtr<ArkWebSelectPopupMenuParam> params,
                    ArkWebRefPtr<ArkWebSelectPopupMenuCallback> callback) = 0;
  ...
  /*--ark web()--*/
  virtual void
  OnDataResubmission(ArkWebRefPtr<ArkWebDataResubmissionCallback> handler) = 0;
  ...
  /*--ark web()--*/
  virtual bool
  OnDragAndDropDataUdmf(ArkWebRefPtr<ArkWebDragData> drag_data) = 0;
   ...
   */
  /*--ark web()--*/
  virtual void OnFirstContentfulPaint(int64_t navigation_start_tick,
                                      int64_t first_contentful_paint_ms) = 0;
  ...
  virtual void OnScreenCaptureRequest(
      ArkWebRefPtr<ArkWebScreenCaptureAccessRequest> request) = 0;
  ...
  /*--ark web()--*/
  virtual void OnOverScrollFlingVelocity(float x_velocity, float y_velocity,
                                         bool is_fling) = 0;
  ...
  virtual void OnNavigationEntryCommitted(
      ArkWebRefPtr<ArkWebLoadCommittedDetails> details) = 0;

  /*--ark web()--*/
  virtual void OnNativeEmbedLifecycleChange(
      ArkWebRefPtr<ArkWebNativeEmbedDataInfo> data_info) = 0;

  /*--ark web()--*/
  virtual void OnNativeEmbedGestureEvent(
      ArkWebRefPtr<ArkWebNativeEmbedTouchEvent> touch_event) = 0;
   ...
   */
  /*--ark web()--*/
  virtual void CreateOverlay(void* data,
                             size_t len,
                             int width,
                             int height,
                             int offset_x,
   ...
   */
  /*--ark web()--*/
  virtual void OnOverlayStateChanged(int offset_x,
                                     int offset_y,
                                     int rect_width,
                                     int rect_height) = 0;
   ...
   */
  /*--ark web()--*/
  virtual bool OnOverScroll(float xOffset,
                            float yOffset,
                            float xVelocity,
                            float yVelocity) = 0;
};
