...
public:
  ...
  /*--ark web()--*/
  virtual void OnTouchPress(int32_t id, double x, double y,
                            bool from_overlay) = 0;

  /*--ark web()--*/
  virtual void OnTouchRelease(int32_t id, double x, double y,
                              bool from_overlay) = 0;

  /*--ark web()--*/
  virtual void OnTouchMove(int32_t id, double x, double y,
                           bool from_overlay) = 0;
  ...
  /*--ark web()--*/
  virtual void SendMouseWheelEvent(double x, double y, double delta_x,
                                   double delta_y) = 0;
  ...
  /*--ark web()--*/
  virtual void
  ExecuteJavaScript(const ArkWebString &code,
  ...
  /*--ark web()--*/
  virtual void
  UnregisterArkJSfunction(const ArkWebString &object_name,
  ...
  /*--ark web()--*/
  virtual void
  PutFindCallback(ArkWebRefPtr<ArkWebFindCallback> find_listener) = 0;
  ...
  /*--ark web()--*/
  virtual void
  SetPortMessageCallback(const ArkWebString &port_handle,
  ...
  virtual void RegisterScreenLockFunction(
      int32_t window_id, ArkWebRefPtr<ArkWebScreenLockCallback> callback) = 0;
   ...
   */
  /*--ark web()--*/
  virtual void SetVirtualKeyBoardArg(int32_t width, int32_t height,
                                     double keyboard) = 0;
   ...
   */
  /*--ark web()--*/
  virtual void SetDrawRect(int32_t x, int32_t y, int32_t width,
                           int32_t height) = 0;
  ...
  /*--ark web()--*/
  virtual void
  JavaScriptOnDocumentStart(const ArkWebStringVectorMap &script_items) = 0;
   ...
   */
  /*--ark web()--*/
  virtual void CallH5Function(int32_t routingId, int32_t h5ObjectId,
  ...
  /*--ark web()--*/
  virtual void
  RegisterNativeArkJSFunction(const char *objName,
  ...
  /*--ark web()--*/
  virtual void
  RegisterNativeValideCallback(const char *webName,
  ...
  /*--ark web()--*/
  virtual void
  RegisterNativeDestroyCallback(const char *webName,
                                const NativeArkWebOnValidCallback callback) = 0;
  ...
  /*--ark web()--*/
  virtual void
  JavaScriptOnDocumentEnd(const ArkWebStringVectorMap &script_items) = 0;
