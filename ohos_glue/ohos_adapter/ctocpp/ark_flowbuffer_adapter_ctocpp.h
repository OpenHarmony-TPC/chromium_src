...
#ifndef ARK_FLOWBUFFER_ADAPTER_CTOCPP_H_
#define ARK_FLOWBUFFER_ADAPTER_CTOCPP_H_
#pragma once
...
class ArkFlowbufferAdapterCToCpp
    : public ArkWebCToCppRefCounted<ArkFlowbufferAdapterCToCpp,
                                    ArkFlowbufferAdapter,
                                    ark_flowbuffer_adapter_t> {
public:
  ArkFlowbufferAdapterCToCpp();
  virtual ~ArkFlowbufferAdapterCToCpp();

  // ArkFlowbufferAdapter methods.
...
#endif // ARK_FLOWBUFFER_ADAPTER_CTOCPP_H_
