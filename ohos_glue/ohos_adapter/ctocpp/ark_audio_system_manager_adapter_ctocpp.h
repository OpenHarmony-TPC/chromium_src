...
#ifndef ARK_AUDIO_SYSTEM_MANAGER_ADAPTER_CTOCPP_H_
#define ARK_AUDIO_SYSTEM_MANAGER_ADAPTER_CTOCPP_H_
#pragma once
...
class ArkAudioSystemManagerAdapterCToCpp
    : public ArkWebCToCppRefCounted<ArkAudioSystemManagerAdapterCToCpp,
                                    ArkAudioSystemManagerAdapter,
                                    ark_audio_system_manager_adapter_t> {
public:
  ArkAudioSystemManagerAdapterCToCpp();
  virtual ~ArkAudioSystemManagerAdapterCToCpp();

  // ArkAudioSystemManagerAdapter methods.
  bool HasAudioOutputDevices() override;

  bool HasAudioInputDevices() override;

  int32_t RequestAudioFocus(
      const ArkWebRefPtr<ArkAudioInterruptAdapter> audioInterrupt) override;

  int32_t AbandonAudioFocus(
      const ArkWebRefPtr<ArkAudioInterruptAdapter> audioInterrupt) override;

  int32_t SetAudioManagerInterruptCallback(
      ArkWebRefPtr<ArkAudioManagerCallbackAdapter> callback) override;
  ...
  bool SetLanguage(const ArkWebString &language) override;
};

} // namespace OHOS::ArkWeb

#endif // ARK_AUDIO_SYSTEM_MANAGER_ADAPTER_CTOCPP_H_
