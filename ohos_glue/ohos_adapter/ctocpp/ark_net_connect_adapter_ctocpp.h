...
#ifndef ARK_NET_CONNECT_ADAPTER_CTOCPP_H_
#define ARK_NET_CONNECT_ADAPTER_CTOCPP_H_
#pragma once
...
class ArkNetConnectAdapterCToCpp
    : public ArkWebCToCppRefCounted<ArkNetConnectAdapterCToCpp,
                                    ArkNetConnectAdapter,
                                    ark_net_connect_adapter_t> {
public:
  ArkNetConnectAdapterCToCpp();
  virtual ~ArkNetConnectAdapterCToCpp();

  // ArkNetConnectAdapter methods.
...
#endif // ARK_NET_CONNECT_ADAPTER_CTOCPP_H_
