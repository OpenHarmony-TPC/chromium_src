...
#ifndef ARK_VSYNC_ADAPTER_CTOCPP_H_
#define ARK_VSYNC_ADAPTER_CTOCPP_H_
#pragma once
...
class ArkVSyncAdapterCToCpp
    : public ArkWebCToCppRefCounted<ArkVSyncAdapterCToCpp, ArkVSyncAdapter,
                                    ark_vsync_adapter_t> {
public:
  ArkVSyncAdapterCToCpp();
  virtual ~ArkVSyncAdapterCToCpp();

  // ArkVSyncAdapter methods.
...
#endif // ARK_VSYNC_ADAPTER_CTOCPP_H_
