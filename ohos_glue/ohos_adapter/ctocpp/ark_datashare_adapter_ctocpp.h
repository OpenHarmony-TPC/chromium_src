...
#ifndef ARK_DATASHARE_ADAPTER_CTOCPP_H_
#define ARK_DATASHARE_ADAPTER_CTOCPP_H_
#pragma once
...
class ArkDatashareAdapterCToCpp
    : public ArkWebCToCppRefCounted<ArkDatashareAdapterCToCpp,
                                    ArkDatashareAdapter,
                                    ark_datashare_adapter_t> {
public:
  ArkDatashareAdapterCToCpp();
  virtual ~ArkDatashareAdapterCToCpp();

  // ArkDatashareAdapter methods.
...
#endif // ARK_DATASHARE_ADAPTER_CTOCPP_H_
