...
uint8_t *ArkCameraSurfaceBufferAdapterCToCpp::GetBufferAddr() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, get_buffer_addr, nullptr);

  // Execute
  return _struct->get_buffer_addr(_struct);
}
...
ArkWebBridgeType ArkWebCToCppRefCounted<
    ArkCameraSurfaceBufferAdapterCToCpp, ArkCameraSurfaceBufferAdapter,
