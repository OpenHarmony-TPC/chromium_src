...
#ifndef ARK_LOCATION_PROXY_ADAPTER_CTOCPP_H_
#define ARK_LOCATION_PROXY_ADAPTER_CTOCPP_H_
#pragma once
...
class ArkLocationProxyAdapterCToCpp
    : public ArkWebCToCppRefCounted<ArkLocationProxyAdapterCToCpp,
                                    ArkLocationProxyAdapter,
                                    ark_location_proxy_adapter_t> {
public:
  ArkLocationProxyAdapterCToCpp();
  virtual ~ArkLocationProxyAdapterCToCpp();

  // ArkLocationProxyAdapter methods.
  int32_t
...
#endif // ARK_LOCATION_PROXY_ADAPTER_CTOCPP_H_
