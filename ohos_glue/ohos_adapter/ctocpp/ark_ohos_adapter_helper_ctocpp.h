...
#ifndef ARK_OHOS_ADAPTER_HELPER_CTOCPP_H_
#define ARK_OHOS_ADAPTER_HELPER_CTOCPP_H_
#pragma once
...
class ArkOhosAdapterHelperCToCpp
    : public ArkWebCToCppRefCounted<ArkOhosAdapterHelperCToCpp,
                                    ArkOhosAdapterHelper,
                                    ark_ohos_adapter_helper_t> {
public:
  ArkOhosAdapterHelperCToCpp();
  virtual ~ArkOhosAdapterHelperCToCpp();

  // ArkOhosAdapterHelper methods.
  ...
  GetWebPermissionDataBaseInstance() override;
  ...
  GetResourceAdapter(const ArkWebString &hapPath) override;

  ArkWebRefPtr<ArkSystemPropertiesAdapter>
  GetSystemPropertiesInstance() override;
  ...
  CreateConsumerSurfaceAdapter() override;
...
#endif // ARK_OHOS_ADAPTER_HELPER_CTOCPP_H_
