...
class ArkIMFAdapterCToCpp
    : public ArkWebCToCppRefCounted<ArkIMFAdapterCToCpp, ArkIMFAdapter,
                                    ark_imfadapter_t> {
public:
  ArkIMFAdapterCToCpp();
  ...
  void
  OnCursorUpdate(ArkWebRefPtr<ArkIMFCursorInfoAdapter> cursorInfo) override;
