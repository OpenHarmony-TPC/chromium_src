...
#ifndef ARK_EVENT_HANDLER_ADAPTER_CTOCPP_H_
#define ARK_EVENT_HANDLER_ADAPTER_CTOCPP_H_
#pragma once
...
class ArkEventHandlerAdapterCToCpp
    : public ArkWebCToCppRefCounted<ArkEventHandlerAdapterCToCpp,
                                    ArkEventHandlerAdapter,
                                    ark_event_handler_adapter_t> {
public:
  ArkEventHandlerAdapterCToCpp();
  virtual ~ArkEventHandlerAdapterCToCpp();

  // ArkEventHandlerAdapter methods.
...
#endif // ARK_EVENT_HANDLER_ADAPTER_CTOCPP_H_
