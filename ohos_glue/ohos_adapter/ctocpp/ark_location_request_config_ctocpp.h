...
#ifndef ARK_LOCATION_REQUEST_CONFIG_CTOCPP_H_
#define ARK_LOCATION_REQUEST_CONFIG_CTOCPP_H_
#pragma once
...
class ArkLocationRequestConfigCToCpp
    : public ArkWebCToCppRefCounted<ArkLocationRequestConfigCToCpp,
                                    ArkLocationRequestConfig,
                                    ark_location_request_config_t> {
public:
  ArkLocationRequestConfigCToCpp();
  virtual ~ArkLocationRequestConfigCToCpp();

  // ArkLocationRequestConfig methods.
...
#endif // ARK_LOCATION_REQUEST_CONFIG_CTOCPP_H_
