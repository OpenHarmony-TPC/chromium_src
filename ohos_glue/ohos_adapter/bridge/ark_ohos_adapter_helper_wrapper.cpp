...
ArkOhosAdapterHelperWrapper::CreatePowerMgrClientAdapter() {
  ArkWebRefPtr<ArkPowerMgrClientAdapter> adapter =
      ctocpp_->CreatePowerMgrClientAdapter();
...
ArkOhosAdapterHelperWrapper::CreateBatteryClientAdapter() {
  ArkWebRefPtr<ArkBatteryMgrClientAdapter> adapter =
      ctocpp_->CreateBatteryClientAdapter();
...
ArkOhosAdapterHelperWrapper::CreateAudioRendererAdapter() {
  ArkWebRefPtr<ArkAudioRendererAdapter> adapter =
      ctocpp_->CreateAudioRendererAdapter();
...
ArkOhosAdapterHelperWrapper::CreateAudioCapturerAdapter() {
  ArkWebRefPtr<ArkAudioCapturerAdapter> adapter =
      ctocpp_->CreateAudioCapturerAdapter();
...
ArkOhosAdapterHelperWrapper::GetKeystoreAdapterInstance() {
  static ArkKeystoreAdapterWrapper instance(
      ctocpp_->GetKeystoreAdapterInstance());
  return instance;
}
...
ArkOhosAdapterHelperWrapper::GetAccessTokenAdapterInstance() {
  static ArkAccessTokenAdapterWrapper instance(
      ctocpp_->GetAccessTokenAdapterInstance());
  return instance;
}
...
ArkOhosAdapterHelperWrapper::CreateConsumerSurfaceAdapter() {
  ArkWebRefPtr<ArkIConsumerSurfaceAdapter> adapter =
      ctocpp_->CreateConsumerSurfaceAdapter();
...
NWeb::HiTraceAdapter &ArkOhosAdapterHelperWrapper::GetHiTraceAdapterInstance() {
  static ArkHiTraceAdapterWrapper instance(
      ctocpp_->GetHiTraceAdapterInstance());
  return instance;
}
...
ArkOhosAdapterHelperWrapper::GetCameraManagerAdapter() {
  static ArkCameraManagerAdapterWrapper instance(
      ctocpp_->GetCameraManagerAdapter());
  return instance;
}

std::unique_ptr<NWeb::ScreenCaptureAdapter>
ArkOhosAdapterHelperWrapper::CreateScreenCaptureAdapter() {
  ArkWebRefPtr<ArkScreenCaptureAdapter> adapter =
      ctocpp_->CreateScreenCaptureAdapter();
...
ArkOhosAdapterHelperWrapper::CreateDateTimeFormatAdapter() {
  ArkWebRefPtr<ArkDateTimeFormatAdapter> adapter =
      ctocpp_->CreateDateTimeFormatAdapter();
...
ArkOhosAdapterHelperWrapper::CreateMediaCodecDecoderAdapter() {
  ArkWebRefPtr<ArkMediaCodecDecoderAdapter> adapter =
      ctocpp_->CreateMediaCodecDecoderAdapter();
...
ArkOhosAdapterHelperWrapper::CreateNativeImageAdapter() {
  ArkWebRefPtr<ArkNativeImageAdapter> adapter =
      ctocpp_->CreateNativeImageAdapter();
...
ArkOhosAdapterHelperWrapper::CreateMediaCodecEncoderAdapter() {
  ArkWebRefPtr<ArkMediaCodecAdapter> adapter =
      ctocpp_->CreateMediaCodecEncoderAdapter();
...
ArkOhosAdapterHelperWrapper::GetMediaCodecListAdapter() {
  static ArkMediaCodecListAdapterWrapper instance(
      ctocpp_->GetMediaCodecListAdapter());
  return instance;
}
...
ArkOhosAdapterHelperWrapper::CreateMediaAVSessionAdapter() {
  ArkWebRefPtr<ArkMediaAVSessionAdapter> adapter =
      ctocpp_->CreateMediaAVSessionAdapter();
