...
ArkDisplayManagerAdapterWrapper::ArkDisplayManagerAdapterWrapper(
    ArkWebRefPtr<ArkDisplayManagerAdapter> ref)
    : ctocpp_(ref) {
}
...
std::shared_ptr<OHOS::NWeb::DisplayAdapter>
ArkDisplayManagerAdapterWrapper::GetDefaultDisplay() {
...
uint32_t ArkDisplayManagerAdapterWrapper::RegisterDisplayListener(
  ...
  return ctocpp_->RegisterDisplayListener(
      new ArkDisplayListenerAdapterImpl(listener));
}
