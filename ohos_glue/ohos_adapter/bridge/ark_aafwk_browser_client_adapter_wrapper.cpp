...
ArkAafwkBrowserClientAdapterWrapper::ArkAafwkBrowserClientAdapterWrapper(
    ArkWebRefPtr<ArkAafwkBrowserClientAdapter> ref)
    : ctocpp_(ref) {}
...
void ArkAafwkBrowserClientAdapterWrapper::ReportThread(
    NWeb::ResSchedStatusAdapter status,
    int32_t process_id,
    int32_t thread_id,
    NWeb::ResSchedRoleAdapter role)
{
