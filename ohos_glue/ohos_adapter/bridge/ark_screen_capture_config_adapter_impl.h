 ...
 */
#ifndef ARK_SCREEN_CAPTURE_CONFIG_ADAPTER_IMPL_H
#define ARK_SCREEN_CAPTURE_CONFIG_ADAPTER_IMPL_H
#pragma once
...
public:
  ArkScreenCaptureConfigAdapterImpl(
      std::shared_ptr<OHOS::NWeb::ScreenCaptureConfigAdapter>);
...
private:
  std::shared_ptr<OHOS::NWeb::ScreenCaptureConfigAdapter> real_;

  IMPLEMENT_REFCOUNTING(ArkScreenCaptureConfigAdapterImpl);
};

} // namespace OHOS::ArkWeb

#endif // ARK_SCREEN_CAPTURE_CONFIG_ADAPTER_IMPL_H
