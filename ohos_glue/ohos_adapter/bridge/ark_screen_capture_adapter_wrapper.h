...
public:
  ArkScreenCaptureAdapterWrapper(ArkWebRefPtr<ArkScreenCaptureAdapter>);

  int32_t
  Init(const std::shared_ptr<NWeb::ScreenCaptureConfigAdapter> config) override;
