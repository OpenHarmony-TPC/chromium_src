...
ArkCertManagerAdapterWrapper::ArkCertManagerAdapterWrapper(
    ArkWebRefPtr<ArkCertManagerAdapter> ref)
    : ctocpp_(ref) {
}
...
int32_t ArkCertManagerAdapterWrapper::GetSytemRootCertData(uint32_t certCount,
                                                           uint8_t *certData) {
...
int32_t ArkCertManagerAdapterWrapper::GetUserRootCertData(uint32_t certCount,
                                                          uint8_t *certData) {
...
int32_t ArkCertManagerAdapterWrapper::GetAppCert(uint8_t *uriData,
                                                 uint8_t *certData,
                                                 uint32_t *len) {
  return ctocpp_->GetAppCert(uriData, certData, len);
}

int32_t ArkCertManagerAdapterWrapper::Sign(const uint8_t *uri,
...
int32_t ArkCertManagerAdapterWrapper::GetCertDataBySubject(
...
int ArkCertManagerAdapterWrapper::VerifyCertFromNetSsl(uint8_t *certData,
                                                       uint32_t certSize) {
...
bool ArkCertManagerAdapterWrapper::GetPinSetForHostName(
