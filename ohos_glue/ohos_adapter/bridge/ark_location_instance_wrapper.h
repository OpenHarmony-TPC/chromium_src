...
#ifndef ARK_LOCATION_INSTANCE_WRAPPER_H
#define ARK_LOCATION_INSTANCE_WRAPPER_H
#pragma once
...
public:
  ...
  std::shared_ptr<NWeb::LocationRequestConfig> CreateLocationRequestConfig();

private:
  ArkWebRefPtr<ArkLocationInstance> ctocpp_;
};

} // namespace OHOS::ArkWeb

#endif // ARK_LOCATION_INSTANCE_WRAPPER_H
