...
#ifndef ARK_MEDIA_AVSESSION_METADATA_ADAPTER_IMPL_H
#define ARK_MEDIA_AVSESSION_METADATA_ADAPTER_IMPL_H
#pragma once
...
class ArkMediaAVSessionMetadataAdapterImpl
    : public ArkMediaAVSessionMetadataAdapter {
public:
  ArkMediaAVSessionMetadataAdapterImpl(
      std::shared_ptr<OHOS::NWeb::MediaAVSessionMetadataAdapter>);
...
private:
  ...
  IMPLEMENT_REFCOUNTING(ArkMediaAVSessionMetadataAdapterImpl);
};

} // namespace OHOS::ArkWeb

#endif // ARK_MEDIA_AVSESSION_METADATA_ADAPTER_IMPL_H
