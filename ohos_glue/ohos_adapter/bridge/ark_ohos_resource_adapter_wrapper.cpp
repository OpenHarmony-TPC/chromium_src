...
ArkOhosResourceAdapterWrapper::ArkOhosResourceAdapterWrapper(
    ArkWebRefPtr<ArkOhosResourceAdapter> ref)
    : ctocpp_(ref) {
}

bool ArkOhosResourceAdapterWrapper::GetRawFileData(const std::string &rawFile,
...
std::shared_ptr<NWeb::OhosFileMapper>
ArkOhosResourceAdapterWrapper::GetRawFileMapper(const std::string &rawFile,
                                                bool isSys) {
  ArkWebString ark_raw_file = ArkWebStringClassToStruct(rawFile);
  ArkWebRefPtr<ArkOhosFileMapper> mapper =
      ctocpp_->GetRawFileMapper(ark_raw_file, isSys);
  ArkWebStringStructRelease(ark_raw_file);
...
bool ArkOhosResourceAdapterWrapper::IsRawFileExist(const std::string &rawFile,
                                                   bool isSys) {
  ArkWebString ark_raw_file = ArkWebStringClassToStruct(rawFile);
