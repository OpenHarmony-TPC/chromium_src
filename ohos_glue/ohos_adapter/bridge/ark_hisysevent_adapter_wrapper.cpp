...
ArkHiSysEventAdapterWrapper::ArkHiSysEventAdapterWrapper(
    ArkWebRefPtr<ArkHiSysEventAdapter> ref)
    : ctocpp_(ref) {
}

int ArkHiSysEventAdapterWrapper::Write(
    const std::string &eventName, ArkEventType type,
  ...
  int result =
      ctocpp_->Write(ark_event_name, (uint32_t)type, ark_key1, ark_value1);
...
int ArkHiSysEventAdapterWrapper::Write(
  ...
  int result = ctocpp_->Write(ark_event_name, (uint32_t)type, ark_key1,
                              ark_value1, ark_key2, ark_value2);
...
int ArkHiSysEventAdapterWrapper::Write(
  ...
  int result =
      ctocpp_->Write(ark_event_name, (uint32_t)type, ark_key1, ark_value1,
                     ark_key2, ark_value2, ark_key3, ark_value3);
...
int ArkHiSysEventAdapterWrapper::Write(
  ...
  int result = ctocpp_->Write(ark_event_name, (uint32_t)type, ark_key1,
                              ark_value1, ark_key2, ark_value2, ark_key3,
...
int ArkHiSysEventAdapterWrapper::Write(
  ...
  int result =
      ctocpp_->Write(ark_event_name, (uint32_t)type, ark_key1, ark_value1,
                     ark_key2, ark_value2, ark_key3, ark_value3, ark_key4,
                     ark_value4, ark_key5, ark_value5);
...
int ArkHiSysEventAdapterWrapper::Write(
  ...
  int result =
      ctocpp_->Write(ark_event_name, (uint32_t)type, ark_key1, ark_value1,
                     ark_key2, ark_value2, ark_key3, ark_value3, ark_key4,
                     ark_value4, ark_key5, ark_value5, ark_key6, ark_value6);
...
int ArkHiSysEventAdapterWrapper::Write(
    const std::string &eventName, ArkEventType type,
    const std::tuple<const std::string, const int64_t, const std::string,
                     const int, const std::string, const std::vector<uint16_t>,
                     const std::string, const int> &data) {
  if (!ctocpp_) {
    return -1;
  }
  ArkWebString ark_event_name = ArkWebStringClassToStruct(eventName);
  ...
  ArkWebString ark_key3 = ArkWebStringClassToStruct(std::get<4>(data));
  ArkWebString ark_key4 = ArkWebStringClassToStruct(std::get<6>(data));
  ArkWebUint16Vector ark_value3 =
      ArkWebBasicVectorClassToStruct<uint16_t, ArkWebUint16Vector>(
          std::get<5>(data));

  int result = ctocpp_->Write(
      ark_event_name, (uint32_t)type, ark_key1, std::get<1>(data), ark_key2,
...
int ArkHiSysEventAdapterWrapper::Write(
    const std::string &eventName, ArkEventType type,
    const std::tuple<const std::string, const int64_t, const std::string,
                     const int64_t, const std::string, const int,
                     const std::string, const int, const std::string,
                     const int64_t, const std::string, const int> &data) {
  if (!ctocpp_) {
    return -1;
  }
  ArkWebString ark_event_name = ArkWebStringClassToStruct(eventName);
  ...
  int result =
      ctocpp_->Write(ark_event_name, (uint32_t)type, ark_key1,
                     std::get<1>(data), ark_key2, std::get<3>(data), ark_key3,
                     std::get<5>(data), ark_key4, std::get<7>(data), ark_key5,
                     std::get<9>(data), ark_key6, std::get<11>(data));
...
int ArkHiSysEventAdapterWrapper::Write(
  ...
  int result = ctocpp_->Write(
      ark_event_name, (uint32_t)type, ark_key1, std::get<1>(data), ark_key2,
      std::get<3>(data), ark_key3, std::get<5>(data), ark_key4,
      std::get<7>(data), ark_key5, std::get<9>(data), ark_key6,
      std::get<11>(data), ark_key7, std::get<13>(data), ark_key8,
      std::get<15>(data), ark_key9, std::get<17>(data), ark_key10,
      std::get<19>(data), ark_key11, std::get<21>(data), ark_key12,
      std::get<23>(data), ark_key13, std::get<25>(data), ark_key14,
      std::get<27>(data), ark_key15, std::get<29>(data), ark_key16,
      std::get<31>(data), ark_key17, std::get<33>(data), ark_key18,
      std::get<35>(data), ark_key19, std::get<37>(data), ark_key20,
      std::get<39>(data), ark_key21, std::get<41>(data), ark_key22,
      std::get<43>(data), ark_key23, std::get<45>(data));
