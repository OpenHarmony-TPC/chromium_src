 ...
 */
#ifndef ARK_BUFFER_DESC_ADAPTER_IMPL_H
#define ARK_BUFFER_DESC_ADAPTER_IMPL_H
#pragma once
...
private:
  std::shared_ptr<OHOS::NWeb::BufferDescAdapter> real_;

  IMPLEMENT_REFCOUNTING(ArkBufferDescAdapterImpl);
};

} // namespace OHOS::ArkWeb

#endif // ARK_BUFFER_DESC_ADAPTER_IMPL_H
