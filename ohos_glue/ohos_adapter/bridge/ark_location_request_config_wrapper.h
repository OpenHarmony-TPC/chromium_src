...
#ifndef ARK_LOCATION_REQUEST_CONFIG_WRAPPER_H
#define ARK_LOCATION_REQUEST_CONFIG_WRAPPER_H
#pragma once
...
class ArkLocationRequestConfigWrapper
    : public OHOS::NWeb::LocationRequestConfig {
public:
  ...
  ArkWebRefPtr<ArkLocationRequestConfig> ctocpp_;
};
