...
class ArkCameraStatusCallbackAdapterImpl
    : public ArkCameraStatusCallbackAdapter {
public:
  ArkCameraStatusCallbackAdapterImpl(
      std::shared_ptr<OHOS::NWeb::CameraStatusCallbackAdapter>);
  void OnCameraStatusChanged(int32_t cameraStatusAdapter,
                             const ArkWebString callBackDeviceId) override;
