 ...
 */
#ifndef ARK_RECORDER_INFO_ADAPTER_IMPL_H
#define ARK_RECORDER_INFO_ADAPTER_IMPL_H
#pragma once
...
private:
  std::shared_ptr<OHOS::NWeb::RecorderInfoAdapter> real_;

  IMPLEMENT_REFCOUNTING(ArkRecorderInfoAdapterImpl);
};

} // namespace OHOS::ArkWeb

#endif // ARK_RECORDER_INFO_ADAPTER_IMPL_H
