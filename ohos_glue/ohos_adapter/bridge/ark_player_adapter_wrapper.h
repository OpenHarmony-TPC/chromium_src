...
public:
  ...
  int32_t SetPlayerCallback(std::shared_ptr<OHOS::NWeb::PlayerCallbackAdapter>
  ...
  int32_t SetVideoSurface(std::shared_ptr<OHOS::NWeb::IConsumerSurfaceAdapter>
                              cSurfaceAdapter) override;
