...
class ArkCameraSurfaceBufferAdapterWrapper
    : public OHOS::NWeb::CameraSurfaceBufferAdapter {
public:
  ArkCameraSurfaceBufferAdapterWrapper(
      ArkWebRefPtr<ArkCameraSurfaceBufferAdapter>);
