...
ArkKeystoreAdapterWrapper::ArkKeystoreAdapterWrapper(
    ArkWebRefPtr<ArkKeystoreAdapter> ref)
    : ctocpp_(ref) {
}

std::string ArkKeystoreAdapterWrapper::EncryptKey(const std::string alias,
...
std::string
ArkKeystoreAdapterWrapper::DecryptKey(const std::string alias,
