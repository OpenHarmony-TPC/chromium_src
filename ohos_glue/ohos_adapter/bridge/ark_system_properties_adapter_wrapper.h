...
class ArkSystemPropertiesAdapterWrapper
    : public OHOS::NWeb::SystemPropertiesAdapter {
public:
  ...
  void AttachSysPropObserver(NWeb::PropertiesKey,
                             NWeb::SystemPropertiesObserver *observer) override;

  void DetachSysPropObserver(NWeb::PropertiesKey,
                             NWeb::SystemPropertiesObserver *observer) override;

  bool GetBoolParameter(const std::string &key, bool defaultValue) override;

  std::vector<NWeb::FrameRateSetting>
  GetLTPOConfig(const std::string &settingName) override;
