...
class ArkAudioRendererOptionsAdapterImpl
    : public ArkAudioRendererOptionsAdapter {
public:
  ArkAudioRendererOptionsAdapterImpl(
      std::shared_ptr<OHOS::NWeb::AudioRendererOptionsAdapter>);
