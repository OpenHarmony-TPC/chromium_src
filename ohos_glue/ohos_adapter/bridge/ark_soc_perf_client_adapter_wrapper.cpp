...
ArkSocPerfClientAdapterWrapper::ArkSocPerfClientAdapterWrapper(
    ArkWebRefPtr<ArkSocPerfClientAdapter> ref)
    : ctocpp_(ref) {
}
...
void ArkSocPerfClientAdapterWrapper::ApplySocPerfConfigByIdEx(int32_t id,
                                                              bool onOffTag) {
