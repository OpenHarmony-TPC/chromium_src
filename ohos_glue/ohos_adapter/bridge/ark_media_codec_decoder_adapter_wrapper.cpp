...
ArkMediaCodecDecoderAdapterWrapper::ArkMediaCodecDecoderAdapterWrapper(
    ArkWebRefPtr<ArkMediaCodecDecoderAdapter> ref)
    : ctocpp_(ref) {
}

OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::CreateVideoDecoderByMime(
...
OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::CreateVideoDecoderByName(
...
OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::ConfigureDecoder(
...
OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::SetParameterDecoder(
    const std::shared_ptr<OHOS::NWeb::DecoderFormatAdapter> format) {
  int32_t result;
  if (CHECK_SHARED_PTR_IS_NULL(format)) {
    ...
    result =
        ctocpp_->SetParameterDecoder(new ArkDecoderFormatAdapterImpl(format));
  }
...
OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::SetOutputSurface(void *window) {
  int32_t result = ctocpp_->SetOutputSurface(window);
  return (OHOS::NWeb::DecoderAdapterCode)result;
}

OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::PrepareDecoder() {
  int32_t result = ctocpp_->PrepareDecoder();
  return (OHOS::NWeb::DecoderAdapterCode)result;
}

OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::StartDecoder() {
  int32_t result = ctocpp_->StartDecoder();
  return (OHOS::NWeb::DecoderAdapterCode)result;
}

OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::StopDecoder() {
  int32_t result = ctocpp_->StopDecoder();
  return (OHOS::NWeb::DecoderAdapterCode)result;
}

OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::FlushDecoder() {
  int32_t result = ctocpp_->FlushDecoder();
  return (OHOS::NWeb::DecoderAdapterCode)result;
}

OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::ResetDecoder() {
  int32_t result = ctocpp_->ResetDecoder();
  return (OHOS::NWeb::DecoderAdapterCode)result;
}

OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::ReleaseDecoder() {
  int32_t result = ctocpp_->ReleaseDecoder();
  return (OHOS::NWeb::DecoderAdapterCode)result;
}

OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::QueueInputBufferDec(
    uint32_t index, int64_t presentationTimeUs, int32_t size, int32_t offset,
    OHOS::NWeb::BufferFlag flag) {
  int32_t result = ctocpp_->QueueInputBufferDec(index, presentationTimeUs, size,
                                                offset, (uint32_t)flag);
  return (OHOS::NWeb::DecoderAdapterCode)result;
}

OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::GetOutputFormatDec(
  ...
  if (CHECK_SHARED_PTR_IS_NULL(format)) {
    ...
    result =
        ctocpp_->GetOutputFormatDec(new ArkDecoderFormatAdapterImpl(format));
  }
...
OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::ReleaseOutputBufferDec(uint32_t index,
                                                           bool isRender) {
...
OHOS::NWeb::DecoderAdapterCode
ArkMediaCodecDecoderAdapterWrapper::SetCallbackDec(
  ...
  if (CHECK_SHARED_PTR_IS_NULL(callback)) {
    ...
    result =
        ctocpp_->SetCallbackDec(new ArkDecoderCallbackAdapterImpl(callback));
  }
