...
class ArkAudioRendererCallbackAdapterImpl
    : public ArkAudioRendererCallbackAdapter {
public:
  ArkAudioRendererCallbackAdapterImpl(
      std::shared_ptr<OHOS::NWeb::AudioRendererCallbackAdapter>);
