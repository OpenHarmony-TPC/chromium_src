...
public:
  /*--ark web()--*/
  virtual int32_t
  Init(const ArkWebRefPtr<ArkScreenCaptureConfigAdapter> config) = 0;
  ...
  /*--ark web()--*/
  virtual int32_t SetCaptureCallback(
      const ArkWebRefPtr<ArkScreenCaptureCallbackAdapter> callback) = 0;
