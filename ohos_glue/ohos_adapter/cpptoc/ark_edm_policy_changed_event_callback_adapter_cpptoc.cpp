...
void ARK_WEB_CALLBACK ark_edm_policy_changed_event_callback_adapter_changed(
  ...
  // Execute
  ArkEdmPolicyChangedEventCallbackAdapterCppToC::Get(self)->Changed();
}
...
ArkEdmPolicyChangedEventCallbackAdapterCppToC::
    ArkEdmPolicyChangedEventCallbackAdapterCppToC() {
  GetStruct()->changed = ark_edm_policy_changed_event_callback_adapter_changed;
}
