...
ark_audio_manager_device_change_callback_adapter_on_device_change(
  ...
  // Execute
  ArkAudioManagerDeviceChangeCallbackAdapterCppToC::Get(self)->OnDeviceChange();
}
...
ArkWebBridgeType ArkWebCppToCRefCounted<
    ...
    ark_audio_manager_device_change_callback_adapter_t>::kBridgeType =
