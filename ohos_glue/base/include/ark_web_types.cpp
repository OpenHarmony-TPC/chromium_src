...
ArkWebU16String
ArkWebU16StringClassToStruct(const std::u16string &class_value) {
  ArkWebU16String struct_value = {.size = class_value.size(),
                                  .ark_web_mem_free_func = ArkWebMemFree};
  if (struct_value.size > 0) {
    struct_value.value =
        (char16_t *)ArkWebMemMalloc((struct_value.size + 1) * sizeof(char16_t));
    memcpy((char *)struct_value.value, (char *)class_value.c_str(),
           struct_value.size * sizeof(char16_t));
...
std::u16string
ArkWebU16StringStructToClass(const ArkWebU16String &struct_value) {
...
ArkWebString ArkWebStringClassToStruct(const std::string &class_value) {
  ...
  ARK_WEB_BASE_DV_LOG("string is %{public}s,length is %{public}d",
                      class_value.c_str(), struct_value.size);
...
ArkWebStringMap ArkWebStringMapClassToStruct(
  ...
  ArkWebStringMap struct_value = {.size = class_value.size(),
                                  .ark_web_mem_free_func = ArkWebMemFree};
  if (struct_value.size > 0) {
    struct_value.key = (ArkWebString *)ArkWebMemMalloc(sizeof(ArkWebString) *
                                                       struct_value.size);
    struct_value.value = (ArkWebString *)ArkWebMemMalloc(sizeof(ArkWebString) *
                                                         struct_value.size);
...
ArkWebStringMapStructToClass(const ArkWebStringMap &struct_value) {
  ...
  for (int count = 0; count < struct_value.size; count++) {
    class_value.insert(std::map<std::string, std::string>::value_type(
        ...
        ArkWebStringStructToClass(struct_value.value[count])));
  }
...
ArkWebStringList
ArkWebStringListClassToStruct(const std::list<std::string> &class_value) {
  ArkWebStringList struct_value = {.size = class_value.size(),
                                   .ark_web_mem_free_func = ArkWebMemFree};
  if (struct_value.size > 0) {
    struct_value.value = (ArkWebString *)ArkWebMemMalloc(sizeof(ArkWebString) *
                                                         struct_value.size);
...
std::list<std::string>
ArkWebStringListStructToClass(const ArkWebStringList &struct_value) {
...
ArkWebStringVector
ArkWebStringVectorClassToStruct(const std::vector<std::string> &class_value) {
  ArkWebStringVector struct_value = {.size = class_value.size(),
                                     .ark_web_mem_free_func = ArkWebMemFree};
  if (struct_value.size > 0) {
    struct_value.value = (ArkWebString *)ArkWebMemMalloc(sizeof(ArkWebString) *
                                                         struct_value.size);
...
ArkWebStringVectorStructToClass(const ArkWebStringVector &struct_value) {
...
ArkWebStringVectorMap ArkWebStringVectorMapClassToStruct(
  ...
  ArkWebStringVectorMap struct_value = {.size = class_value.size(),
                                        .ark_web_mem_free_func = ArkWebMemFree};
  if (struct_value.size > 0) {
    struct_value.key = (ArkWebString *)ArkWebMemMalloc(sizeof(ArkWebString) *
                                                       struct_value.size);
    struct_value.value = (ArkWebStringVector *)ArkWebMemMalloc(
        sizeof(ArkWebStringVector) * struct_value.size);
...
ArkWebStringVectorMapStructToClass(const ArkWebStringVectorMap &struct_value) {
