...
struct COMPONENTS_DOWNLOAD_EXPORT NWebIdData : public base::SupportsUserData::Data {
 ...
 private:
  ...
  void RunCallbackIfExsitsCallback();
  void RunCallbackIfExsitsCallbackInternal();
  ...
  base::OnceCallback<void(const std::vector<uint8_t>&)> read_download_callback_from_ui_;
