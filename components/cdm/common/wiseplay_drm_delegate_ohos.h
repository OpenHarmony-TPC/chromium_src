...
class WiseplayDrmDelegateOhos : public media::OhosMediaDrmBridgeDelegate {
 public:
  WiseplayDrmDelegateOhos();

  WiseplayDrmDelegateOhos(const WiseplayDrmDelegateOhos&) = delete;
  WiseplayDrmDelegateOhos& operator=(const WiseplayDrmDelegateOhos&) = delete;

  ~WiseplayDrmDelegateOhos() override;
