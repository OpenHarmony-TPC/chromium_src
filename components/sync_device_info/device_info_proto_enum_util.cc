...
syncer::DeviceInfo::OsType ToDeviceInfoOsType(
  ...
  switch (os_type) {
    ...
    case sync_pb::SyncEnums::OsType::SyncEnums_OsType_OS_TYPE_OHOS:
      return syncer::DeviceInfo::OsType::kOhos;
...
#if BUILDFLAG(IS_OHOS)
    case DeviceInfo::OsType::kOhos:
      return sync_pb::SyncEnums::OsType::SyncEnums_OsType_OS_TYPE_OHOS;
#endif  // BUILDFLAG(IS_OHOS)
  }
}
