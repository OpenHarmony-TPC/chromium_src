...
// Owned by the underlying UserRulesetService. Its main responsibility is
// receiving new versions of subresource filtering rules from the
// UserRulesetService, and distributing them to renderer processes, where they
// will be memory-mapped as-needed by an UnverifiedRulesetDealer.
//
...
class UserRulesetPublisher : public content::RenderProcessHostCreationObserver {
 ...
 protected:
  ...
  virtual void UserSendRulesetToRenderProcess(
      base::File* file,
