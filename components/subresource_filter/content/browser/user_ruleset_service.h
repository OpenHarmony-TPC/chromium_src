...
#ifndef COMPONENTS_SUBRESOURCE_FILTER_CONTENT_BROWSER_USER_RULESET_SERVICE_H_
#define COMPONENTS_SUBRESOURCE_FILTER_CONTENT_BROWSER_USER_RULESET_SERVICE_H_
...
class UserRulesetService : public base::SupportsWeakPtr<UserRulesetService> {
 public:
...
#endif  // COMPONENTS_SUBRESOURCE_FILTER_CONTENT_BROWSER_USER_RULESET_SERVICE_H_
