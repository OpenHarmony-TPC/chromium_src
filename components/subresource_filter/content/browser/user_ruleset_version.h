...
#ifndef COMPONENTS_SUBRESOURCE_FILTER_CONTENT_BROWSER_USER_RULESET_VERSION_H_
#define COMPONENTS_SUBRESOURCE_FILTER_CONTENT_BROWSER_USER_RULESET_VERSION_H_
...
extern const char kSubresourceFilterUserRulesetContentVersion[];
extern const char kSubresourceFilterUserRulesetFormatVersion[];
extern const char kSubresourceFilterUserRulesetChecksum[];
extern const char kSubresourceFilterUserEasylistPath[];
extern const char kSubresourceFilterUserEasylistReplace[];
...
#endif  // COMPONENTS_SUBRESOURCE_FILTER_CONTENT_BROWSER_USER_RULESET_VERSION_H_
