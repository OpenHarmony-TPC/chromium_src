...
const int SystemMemoryPressureEvaluator::kDefaultCriticalThresholdPc = 90;
const int kFullMemoryThresholdPc = 100;
...
bool SystemMemoryPressureEvaluator::InferThresholds() {
  ...
  critical_threshold_mb_ = base::checked_cast<int>(
      ...
      (kFullMemoryThresholdPc - kDefaultCriticalThresholdPc) /
      kFullMemoryThresholdPc / kKiBperMiB);
  moderate_threshold_mb_ = base::checked_cast<int>(
      static_cast<uint64_t>(mem_info.total) *
      (kFullMemoryThresholdPc - kDefaultModerateThresholdPc) /
      kFullMemoryThresholdPc / kKiBperMiB);
  return true;
}
