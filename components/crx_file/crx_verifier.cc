...
#if BUILDFLAG(ARKWEB_ARKWEB_EXTENSIONS)
constexpr uint8_t kHuaweiPublisherKeyHash[] = {
    0x7d, 0xec, 0xda, 0xcb, 0x78, 0xca, 0x01, 0xc8, 0x57, 0x91, 0xea,
    0x5a, 0x44, 0x0c, 0x21, 0x6c, 0x05, 0x98, 0xdb, 0xfb, 0xc8, 0xfc,
    0xa1, 0x8a, 0x12, 0x74, 0xb1, 0x94, 0x60, 0x5f, 0xb1, 0x3a};
#endif
...
std::unordered_set<ByteVec, VectorHash> BuildAllowedPublisherSet() {
  ...
  if (hashes.empty()) {
    ...
    hashes.emplace_back(std::begin(kHuaweiPublisherKeyHash),
                        std::end(kHuaweiPublisherKeyHash));
  }
