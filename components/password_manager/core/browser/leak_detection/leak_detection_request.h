...
class LeakDetectionRequest : public LeakDetectionRequestInterface {
 public:
  ...
  inline static constexpr char kRequestCriticalityHeader[] =
      "x-goog-ext-174067345-bin";
  // The result of base64 encoding CRITICAL criticality value.
  // It is generated by running:
  // `echo "request_qos { criticality: CRITICAL }" | printproto --proto2 \`
  // `--reverse --raw_protocol_buffer \`
  // `--message=frameworks.client.data.QosExtension | base64`
  inline static constexpr char kRequestCriticalityCritical[] = "CgIIAg==";
  // The result of base64 encoding SHEDDABLE_PLUS criticality value.
  // It is generated by running:
  // `echo "request_qos { criticality: SHEDDABLE_PLUS }" | printproto \`
  // `--proto2 --reverse --raw_protocol_buffer \`
  // `--message=frameworks.client.data.QosExtension | base64`
  inline static constexpr char kRequestCriticalitySheddablePlus[] = "CgIIAQ==";
