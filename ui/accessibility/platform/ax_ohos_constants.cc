...
// window scene
AX_EXPORT extern const char ROOT_SCENE_ETS_TAG[] = "RootScene";
AX_EXPORT extern const char SCREEN_ETS_TAG[] = "Screen";
AX_EXPORT extern const char WINDOW_SCENE_ETS_TAG[] = "WindowScene";
