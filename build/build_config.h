...
//              or MAC or NETBSD or OPENBSD or QNX or SOLARIS or OHOS
...
// more specific macro.
    ...
    defined(OS_ZOS) || defined(OS_OHOS)
#define OS_POSIX 1
#endif
...
#if defined(IS_ARKWEB_TRUE)
#define BUILDFLAG_INTERNAL_IS_ARKWEB() (1)
#else
#define BUILDFLAG_INTERNAL_IS_ARKWEB() (0)
#endif

#if defined(ENABLE_ARKWEB_EXT_TRUE)
#define BUILDFLAG_INTERNAL_ENABLE_ARKWEB_EXT() (1)
#else
#define BUILDFLAG_INTERNAL_ENABLE_ARKWEB_EXT() (0)
#endif

#if defined(IS_ARKWEB_EXT_TRUE)
