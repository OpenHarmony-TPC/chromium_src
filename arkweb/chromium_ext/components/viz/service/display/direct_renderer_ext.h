 ...
 */
#ifndef COMPONENTS_VIZ_SERVICE_DISPLAY_DIRECT_RENDERER_EXT_H_
#define COMPONENTS_VIZ_SERVICE_DISPLAY_DIRECT_RENDERER_EXT_H_

#define CHECK_DAMAGE_RECT_WHEN_VULKAN(device_viewport_size) \
