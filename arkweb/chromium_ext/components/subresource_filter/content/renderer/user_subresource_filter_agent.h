...
#ifndef COMPONENTS_SUBRESOURCE_FILTER_CONTENT_RENDERER_USER_SUBRESOURCE_FILTER_AGENT_H_
#define COMPONENTS_SUBRESOURCE_FILTER_CONTENT_RENDERER_USER_SUBRESOURCE_FILTER_AGENT_H_
...
class UserSubresourceFilterAgent
 ...
 public:
  ...
  ~UserSubresourceFilterAgent() override;
 ...
 protected:
  ...
  virtual void SetUserSubresourceFilterForCurrentDocument(
 ...
 private:
  ...
  mojom::UserSubresourceFilterHost* GetSubresourceFilterHost();
  ...
  raw_ptr<UserUnverifiedRulesetDealer> ruleset_dealer_;
  ...
  mojo::AssociatedReceiver<mojom::UserSubresourceFilterAgent> receiver_{this};
...
#endif  // COMPONENTS_SUBRESOURCE_FILTER_CONTENT_RENDERER_USER_SUBRESOURCE_FILTER_AGENT_H_
