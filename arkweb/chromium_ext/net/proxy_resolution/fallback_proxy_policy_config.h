...
#ifndef HUAWEI_NET_PROXY_RESOLUTION_FALLBACK_PROXY_POLICY_CONFIG_H_
#define HUAWEI_NET_PROXY_RESOLUTION_FALLBACK_PROXY_POLICY_CONFIG_H_
...
#endif  // HUAWEI_NET_PROXY_RESOLUTION_FALLBACK_PROXY_POLICY_CONFIG_H_