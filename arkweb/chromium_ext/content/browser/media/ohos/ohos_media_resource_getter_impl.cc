...
OHOSMediaResourceGetterImpl::OHOSMediaResourceGetterImpl(
    BrowserContext* browser_context,
...
void OHOSMediaResourceGetterImpl::GetAuthCredentials(
    const GURL& url,
...
void OHOSMediaResourceGetterImpl::GetAuthCredentialsCallback(
    GetAuthCredentialsCB callback,
