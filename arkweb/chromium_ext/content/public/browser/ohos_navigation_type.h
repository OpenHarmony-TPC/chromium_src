...
// Based on navigation_type.h originally written by
// Copyright (c) 2012 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file. 

#ifndef ARKWEB_CHROMIUM_EXT_CONTENT_PUBLIC_BROWSER_OHOS_NAVIGATION_TYPE_H_
#define ARKWEB_CHROMIUM_EXT_CONTENT_PUBLIC_BROWSER_OHOS_NAVIGATION_TYPE_H_

namespace content {

// Indicates different types of navigations that can occur that we will handle
// separately.
enum OhosNavigationType {
  // Unknown type.
  OHOS_NAVIGATION_TYPE_UNKNOWN,
  ...
  // frame navigation.
  OHOS_NAVIGATION_TYPE_MAIN_FRAME_NEW_ENTRY,
  ...
  OHOS_NAVIGATION_TYPE_NEW_SUBFRAME,
  ...
  OHOS_NAVIGATION_TYPE_AUTO_SUBFRAME,
};

}  // namespace content

#endif  // ARKWEB_CHROMIUM_EXT_CONTENT_PUBLIC_BROWSER_OHOS_NAVIGATION_TYPE_H_
