...
class VideoUrlLoaderImplTest :  public testing::Test,
                                public WebAssociatedURLLoaderClient {
public:
  VideoUrlLoaderImplTest() 
...
TEST_F(VideoUrlLoaderImplTest, VideoOpt_SameOriginSuccess) {
...
TEST_F(VideoUrlLoaderImplTest, VideoOpt_SameOriginRestriction) {
...
TEST_F(VideoUrlLoaderImplTest, VideoOpt_CrossOriginSuccess) {
  // This is cross-origin since the frame was loaded from www.test.com.
...
TEST_F(VideoUrlLoaderImplTest, VideoOpt_RedirectSuccess) {
...
TEST_F(VideoUrlLoaderImplTest, VideoOpt_RedirectCrossOriginFailure) {
...
TEST_F(VideoUrlLoaderImplTest, VideoOpt_RedirectCrossOriginWithAccessControlSuccess) {
  KURL url = ToKURL(
...
TEST_F(VideoUrlLoaderImplTest, VideoOpt_UntrustedCheckMethods) {
...
TEST_F(VideoUrlLoaderImplTest, VideoOpt_MAYBE_UntrustedCheckHeaders) {
...
TEST_F(VideoUrlLoaderImplTest, VideoOpt_CrossOriginHeaderSafelisting) {
...
// CORS loads.
TEST_F(VideoUrlLoaderImplTest, VideoOpt_CrossOriginHeaderAllowResponseHeaders) {
  KURL url =
...
TEST_F(VideoUrlLoaderImplTest, VideoOpt_AccessCheckForLocalURL) {
...
TEST_F(VideoUrlLoaderImplTest, VideoOpt_BypassAccessCheckForLocalURL) {
  KURL url = ToKURL("file://test.pdf");
