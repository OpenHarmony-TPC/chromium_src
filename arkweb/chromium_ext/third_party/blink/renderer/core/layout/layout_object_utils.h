...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_LAYOUT_LAYOUT_OBJECT_UTILS_H_
...
class CORE_EXPORT LayoutObjectUtils : public GarbageCollected<LayoutObjectUtils> {
 public:
  ...
  static bool get_position_mode_;
#endif
};
}  // namespace blink
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_LAYOUT_LAYOUT_OBJECT_UTILS_H_
