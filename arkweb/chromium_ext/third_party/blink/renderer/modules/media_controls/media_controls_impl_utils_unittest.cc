...
class MediaControlsImplUtilsTest : public PageTestBase {
 public:
  void SetUp() final {
    ...
    mediaControlsImplUtils_ = std::make_unique<MediaControlsImplUtils>(media_controls_.Get(), GetMediaElement());
  }
 ...
 protected:
  ...
  std::unique_ptr<MediaControlsImplUtils> mediaControlsImplUtils_;
};
