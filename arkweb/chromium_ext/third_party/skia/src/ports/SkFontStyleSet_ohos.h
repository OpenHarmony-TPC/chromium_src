...
class SkFontStyleSet_OHOS : public SkFontStyleSet {
 ...
 private:
  std::shared_ptr<FontConfig_OHOS> fontConfig_ =
      nullptr;              // the object of FontConfig_OHOS
  int styleIndex = 0;       // the index of the font style set
  bool isFallback = false;  // the flag of font style set. False for fallback
                            // family, true for generic family.
