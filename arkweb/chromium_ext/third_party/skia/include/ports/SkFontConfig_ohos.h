...
#ifndef SkFontConfig_ohos_DEFINED
#define SkFontConfig_ohos_DEFINED
...
#include "arkweb/chromium_ext/third_party/skia/include/ports/SkTypeface_ohos.h"
...
#endif /* SkFontConfig_ohos_DEFINED */
