...
typedef enum FIDO2_AttestationConveyancePreference {
     ...
     *  which is an attestation statement that may include information
     *  which uniquely identifies the authenticator. */
    FIDO2_ENTERPRISE = 3
...
typedef enum FIDO2_ClientCapability {
    ...
    FIDO2_SIGNAL_UNKNOW_CREDENTIAL = 8,
...
typedef struct FIDO2_AuthenticatorMetadata {
    ...
    char **extensions;
    /** The num of extensions. */
    uint32_t extensionsNum;
