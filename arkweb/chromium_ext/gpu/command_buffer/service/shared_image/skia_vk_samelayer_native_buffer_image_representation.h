...
#ifndef GPU_COMMAND_BUFFER_SERVICE_SHARED_IMAGE_SKIA_VK_SAMELAYER_NATIVE_BUFFER_IMAGE_REPRESENTATION_H_
#define GPU_COMMAND_BUFFER_SERVICE_SHARED_IMAGE_SKIA_VK_SAMELAYER_NATIVE_BUFFER_IMAGE_REPRESENTATION_H_
...
// OHOS.
class SkiaVkSamelayerNBImageRepresentation : public SkiaGaneshImageRepresentation {
 public:
  SkiaVkSamelayerNBImageRepresentation(SharedImageManager* manager,
                              OhosImageBacking* backing,
                              scoped_refptr<SharedContextState> context_state,
                              MemoryTypeTracker* tracker);

  ~SkiaVkSamelayerNBImageRepresentation() override;
...
#endif  // GPU_COMMAND_BUFFER_SERVICE_SHARED_IMAGE_SKIA_VK_SAMELAYER_NATIVE_BUFFER_IMAGE_REPRESENTATION_H_