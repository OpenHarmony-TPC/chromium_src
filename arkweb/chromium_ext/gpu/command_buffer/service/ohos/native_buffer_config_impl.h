...
class NativeBufferConfigAdapterImpl : public NativeBufferConfigAdapter {
 public:
  NativeBufferConfigAdapterImpl();

  ~NativeBufferConfigAdapterImpl() override;
...
#endif  // NATIVE_BUFFER_CONFIG_IMPL_H
