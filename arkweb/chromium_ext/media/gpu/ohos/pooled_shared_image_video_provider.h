...
#ifndef MEDIA_GPU_OHOS_POOLED_SHARED_IMAGE_VIDEO_PROVIDER_H_
#define MEDIA_GPU_OHOS_POOLED_SHARED_IMAGE_VIDEO_PROVIDER_H_
...
#endif  // MEDIA_GPU_OHOS_POOLED_SHARED_IMAGE_VIDEO_PROVIDER_H_
