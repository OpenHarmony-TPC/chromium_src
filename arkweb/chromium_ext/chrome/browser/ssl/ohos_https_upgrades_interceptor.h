...
#ifndef OHOS_BROWSER_SSL_HTTPS_UPGRADES_INTERCEPTOR_H_
#define OHOS_BROWSER_SSL_HTTPS_UPGRADES_INTERCEPTOR_H_
...
class OhosHttpsUpgradesInterceptor : public content::URLLoaderRequestInterceptor,
                                     public network::mojom::URLLoader {
 public:
  static std::unique_ptr<OhosHttpsUpgradesInterceptor> MaybeCreateInterceptor(
      content::FrameTreeNodeId frame_tree_node_id);

  OhosHttpsUpgradesInterceptor(content::FrameTreeNodeId frame_tree_node_id);
  ~OhosHttpsUpgradesInterceptor() override;

  OhosHttpsUpgradesInterceptor(const OhosHttpsUpgradesInterceptor&) = delete;
  OhosHttpsUpgradesInterceptor& operator=(const OhosHttpsUpgradesInterceptor&) = delete;
 ...
 private:
  ...
  base::WeakPtrFactory<OhosHttpsUpgradesInterceptor> weak_factory_{this};
};

#endif  // OHOS_BROWSER_SSL_HTTPS_UPGRADES_INTERCEPTOR_H_
