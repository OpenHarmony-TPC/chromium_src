                                    ...
                                    OH_AudioStream_Result error)
{
    ...
    if (userData) {
        return (static_cast<AudioRendererAdapterImpl*>(userData))->OnError(error);
    }
    return 0;
}
                                             ...
                                             OH_AudioInterrupt_Hint hint)
{
    ...
    if (userData) {
        return (static_cast<AudioRendererAdapterImpl*>(userData))->OnInterruptEvent(type, hint);
    }
    return 0;
}
    ...
    OH_AudioStream_DeviceChangeReason reason)
{
    ...
    if (userData) {
        (static_cast<AudioRendererAdapterImpl*>(userData))->OnOutputDeviceChange(reason);
    }
}
