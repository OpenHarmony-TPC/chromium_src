...
#ifndef NET_CONFIG_ADAPTER_IMPL_H
#define NET_CONFIG_ADAPTER_IMPL_H

#include "arkweb/ohos_adapter_ndk/interfaces/net_config_adapter.h"

namespace OHOS::NWeb {
class NetConfigAdapterImpl final : public NetConfigAdapter {
 public:
...
#endif  // NET_CONFIG_ADAPTER_IMPL_H
