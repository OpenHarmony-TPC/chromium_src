...
public:
    ...
    virtual void OnAudioBufferAvailableV2(bool isReady, AudioCaptureSourceTypeAdapter type, int32_t nweb_id) {}
...
public:
    ...
    virtual int32_t InitV2(const std::shared_ptr<ScreenCaptureConfigAdapter> config, int32_t nweb_id)
    {
        return -1;
    }
};
