 ...
 *
 * @brief Declare deviceinfo interface.
 *
 ...
 * @param aVCastCategory The pointer {@link AVSession_AVCastCategory} variable that will be set the device Cast Category value.
