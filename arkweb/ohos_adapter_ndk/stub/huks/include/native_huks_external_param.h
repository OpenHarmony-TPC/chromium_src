...
struct OH_Huks_Result OH_Huks_GetExtParam(const struct OH_Huks_ExternalCryptoParamSet *paramSet, uint32_t tag,
    struct OH_Huks_ExternalCryptoParam **param);
 ...
 * @version 1.0
 */
struct OH_Huks_Result OH_Huks_CheckExtParamMatch(const struct OH_Huks_ExternalCryptoParam *baseParam,
    const struct OH_Huks_ExternalCryptoParam *param);
