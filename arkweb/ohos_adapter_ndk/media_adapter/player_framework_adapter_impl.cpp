...
bool IsFatalError(int32_t errorCode)
{
    switch (errorCode) {
        ...
        case OH_AVErrCode::AV_ERR_IO_CANNOT_FIND_HOST:
        case OH_AVErrCode::AV_ERR_IO_NETWORK_UNAVAILABLE:
        case OH_AVErrCode::AV_ERR_IO_NO_PERMISSION:
        case OH_AVErrCode::AV_ERR_IO_NETWORK_ACCESS_DENIED:
        case OH_AVErrCode::AV_ERR_IO_RESOURCE_NOT_FOUND:
        case OH_AVErrCode::AV_ERR_IO_UNSUPPORTED_REQUEST:
            return true;
        default:
            return false;
    }
...
NWeb::PlayerOnInfoType ConvertInfoType(AVPlayerOnInfoType infoType)
{
    ...
    switch (infoType) {
        ...
        case AVPlayerOnInfoType::AV_INFO_TYPE_INTERRUPT_EVENT:
            ...
            break;
        case AVPlayerOnInfoType::AV_INFO_TYPE_RESOLUTION_CHANGE:
...
void PlayerInfoCallback(OH_AVPlayer *player, AVPlayerOnInfoType type, OH_AVFormat* infoBody, void *userData)
{
    ...
    switch (type) {
        case AVPlayerOnInfoType::AV_INFO_TYPE_STATE_CHANGE:
            ...
            break;
        case AVPlayerOnInfoType::AV_INFO_TYPE_POSITION_UPDATE:
            OH_AVFormat_GetIntValue(infoBody, OH_PLAYER_CURRENT_POSITION, &state);
            break;
        case AVPlayerOnInfoType::AV_INFO_TYPE_INTERRUPT_EVENT:
            OH_AVFormat_GetIntValue(infoBody, OH_PLAYER_AUDIO_INTERRUPT_HINT, &hintValue);
            break;
        case AVPlayerOnInfoType::AV_INFO_TYPE_RESOLUTION_CHANGE:
            OH_AVFormat_GetIntValue(infoBody, OH_PLAYER_VIDEO_WIDTH, &state);
            OH_AVFormat_GetIntValue(infoBody, OH_PLAYER_VIDEO_HEIGHT, &hintValue);
            break;
        default:
            break;
    }
...
int32_t PlayerAdapterImpl::SetVideoSurfaceNew(void* native_window)
{
    ...
    return GetErrorCode(OH_AVPlayer_SetVideoSurface(player_, ohNativeWindow));
}
