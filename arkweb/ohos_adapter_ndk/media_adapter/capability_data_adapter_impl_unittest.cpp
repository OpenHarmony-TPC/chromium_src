...
#include "arkweb/ohos_adapter_ndk/media_adapter/include/capability_data_adapter_impl.h"
#undef private
 ...
 */
TEST_F(CapabilityDataAdapterImplTest,
         GetMaxWidth_ShouldReturnMaxWidth_WhenCalled)
{
 ...
 */
TEST_F(CapabilityDataAdapterImplTest,
         GetMaxHeight_ShouldReturnMaxHeight_WhenCalled)
{
    CapabilityDataAdapterImpl capabilityDataAdapterImpl;
 ...
 */
TEST_F(CapabilityDataAdapterImplTest,
         GetMaxframeRate_ShouldReturnMaxframeRate_WhenCalled)
{
    CapabilityDataAdapterImpl capabilityDataAdapterImpl;
