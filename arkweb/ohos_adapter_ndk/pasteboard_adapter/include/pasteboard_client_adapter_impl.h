...
public:
    ...
    void Clear();
private:
    PIXEL_FORMAT ClipBoardToPixelColorType(ClipBoardImageColorType colorType);
    ClipBoardImageColorType PixelToClipBoardColorType(PIXEL_FORMAT colorType);
    PIXELMAP_ALPHA_TYPE ClipboardToPixelAlphaType(ClipBoardImageAlphaType alphaType);
    ClipBoardImageAlphaType PixelToClipboardAlphaType(PIXELMAP_ALPHA_TYPE alphaType);
