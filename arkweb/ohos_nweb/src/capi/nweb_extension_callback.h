...
#ifndef OHOS_NWEB_SRC_NWEB_EXTENSION_CALLBACK_H_
#define OHOS_NWEB_SRC_NWEB_EXTENSION_CALLBACK_H_

#include <stddef.h>

#include <string>

struct NWebExtensionCallback {
  size_t struct_size = sizeof(NWebExtensionCallback);
  int nweb_id{0};
