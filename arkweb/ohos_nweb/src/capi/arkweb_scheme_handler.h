...
typedef enum ArkWeb_CustomSchemeOption {
  ...
  /*
   * @brief If ARKWEB_SCHEME_OPTION_STANDARD is set the scheme will be handled
   * as a standard scheme. The standard schemes needs to comply with the URL
   * normalization and parsing rules defined in Section 3.1 of RFC 1738, which
   * can be found in the http://www.ietf.org/rfc/rfc1738.txt.
   *
   * @syscap SystemCapability.Web.Webview.Core
   * @since 12
   */
  ...
  /*
   * @brief If ARKWEB_SCHEME_OPTION_LOCAL is set, the same security rules as
   * those applied to the "file" URL will be used to handle the scheme.
   *
   * @syscap SystemCapability.Web.Webview.Core
   * @since 12
   */
  ...
  /*
   * @brief If ARKWEB_SCHEME_OPTION_DISPLAY_ISOLATED is set, then the scheme can
   * only be displayed from other content hosted using the same scheme.
   *
   * @syscap SystemCapability.Web.Webview.Core
   * @since 12
   */
  ...
  /*
   * @brief If ARKWEB_SCHEME_OPTION_SECURE is set, the same security rules as
   * those applied to the "https" URL will be used to handle the scheme.
   *
   * @syscap SystemCapability.Web.Webview.Core
   * @since 12
   */
  ...
  /*
   * @brief If ARKWEB_SCHEME_OPTION_CORS_ENABLED is set, then the scheme can be
   * sent CORS requests. In most case this value should be set when
   * ARKWEB_SCHEME_OPTION_STANDARD is set.
   *
   * @syscap SystemCapability.Web.Webview.Core
   * @since 12
   */
  ...
  /*
   * @brief If ARKWEB_SCHEME_OPTION_CSP_BYPASSING is set, then this scheme can
   * bypass Content Security Policy (CSP) checks. In most cases, this value
   * should not be set when ARKWEB_SCHEME_OPTION_STANDARD is set.
   *
   * @syscap SystemCapability.Web.Webview.Core
   * @since 12
   */
  ...
  /*
   * @brief If ARKWEB_SCHEME_OPTION_FETCH_ENABLED is set, then this scheme can
   * perform FETCH API requests.
   *
   * @syscap SystemCapability.Web.Webview.Core
   * @since 12
   */
  ...
  /*
   * @brief If ARKWEB_SCHEME_OPTION_CODE_CACHE_ENABLED is set, then the js of
   * this scheme can generate code cache.
   *
   * @syscap SystemCapability.Web.Webview.Core
   * @since 12
   */
...
/*
 * @brief Used to intercept url requests. Response headers and body can be sent
 * through ArkWeb_ResourceHandler.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
...
/*
 * @brief The info of the request. You can obtain the requested URL, method,
 * post data, and other information through OH_ArkWeb_ResourceRequest.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
...
/*
 * @brief The http body of the request. Use OH_ArkWebHttpBodyStream_* interface
 * to read the body.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 ...
 * thread. Should destory the resourceRequest by ArkWeb_ResourceRequest_Destroy
 * and use ArkWeb_ResourceHandler_Destroy destroy the ArkWeb_ResourceHandler
 * received in ArkWeb_OnRequestStart.
 * @param schemeHandler The ArkWeb_SchemeHandler.
 ...
 * @param bytesRead Callback after OH_ArkWebHttpBodyStream_Read. bytesRead
 * greater than 0 means that the buffer is filled with data of bytesRead size.
 * Caller can read from the buffer, and if OH_ArkWebHttpBodyStream_IsEOF is
 * false, caller can continue to read the remaining data.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
typedef void (*ArkWeb_HttpBodyStreamReadCallback)(
 ...
 * @param httpBodyStream The ArkWeb_HttpBodyStream.
 * @param buffer The buffer to receive data.
 * @param bytesRead Callback after OH_ArkWebHttpBodyStream_AsyncRead. bytesRead
 * greater than 0 means that the buffer is filled with data of bytesRead size.
 * Caller can read from the buffer, and if OH_ArkWebHttpBodyStream_IsEOF is
 * false, caller can continue to read the remaining data.
 *
 ...
 * @since 12
 */
int32_t OH_ArkWebRequestHeaderList_GetSize(
 ...
 * @param key The header key. Caller must release the string by
 * OH_ArkWeb_ReleaseString.
 * @param value The header value. Caller must release the string by
 * OH_ArkWeb_ReleaseString.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 ...
 * @param resourceRequest The ArkWeb_ResourceRequest.
 * @param method The request's http method. This function will allocate memory
 * for the method string and caller must release the string by
 * OH_ArkWeb_ReleaseString.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
void OH_ArkWebResourceRequest_GetMethod(
    const ArkWeb_ResourceRequest* resourceRequest,
    char** method);
 ...
 * @param resourceRequest The ArkWeb_ResourceRequest.
 * @param url The request's url. This function will allocate memory for the url
 * string and caller must release the string by OH_ArkWeb_ReleaseString.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
void OH_ArkWebResourceRequest_GetUrl(
    const ArkWeb_ResourceRequest* resourceRequest,
    char** url);
 ...
 * @param resourceRequest The ArkWeb_ResourceRequest.
 * @param httpBodyStream The request's http body. This function will allocate
 * memory for the http body stream and caller must release the httpBodyStream by
 ...
 * @since 12
 */
void OH_ArkWebResourceRequest_DestroyHttpBodyStream(
    ArkWeb_HttpBodyStream* httpBodyStream);
 ...
 * @since 12
 */
int32_t OH_ArkWebResourceRequest_GetResourceType(
    const ArkWeb_ResourceRequest* resourceRequest);

/*
 * @brief Get the url of frame which trigger this request.
 * @param resourceRequest The ArkWeb_ResourceRequest.
 * @param frameUrl The url of frame which trigger this request. This function
 * will allocate memory for the url string and caller must release the string by
 * OH_ArkWeb_ReleaseString.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 ...
 * @since 12
 */
int32_t OH_ArkWebHttpBodyStream_SetUserData(
    ArkWeb_HttpBodyStream* httpBodyStream,
    void* userData);
 ...
 * @since 12
 */
void* OH_ArkWebHttpBodyStream_GetUserData(
    const ArkWeb_HttpBodyStream* httpBodyStream);

/*
 * @brief Set the callback for OH_ArkWebHttpBodyStream_Read, the result of
 * OH_ArkWebHttpBodyStream_Read will be notified to caller through the
 * readCallback. The callback will runs in the same thread as
 ...
 *
 * The result of OH_ArkWebHttpBodyStream_AsyncRead will be notified to caller
 * through the\n readCallback. The callback will runs in the ArkWeb worker
 * thread.\n
 *
 * @param httpBodyStream The ArkWeb_HttpBodyStream.
 * @param readCallback The callback of read function.
...
/*
 * @brief Init the http body stream. This function must be called before calling
 * any other functions.
 * @param httpBodyStream The ArkWeb_HttpBodyStream.
...
/*
 * @brief Read the http body to the buffer. The buffer must be larger than the
 * bufLen. We will be reading data from a worker thread to the buffer, so should
 * not use the buffer in other threads before the callback to avoid concurrency
 * issues.
 * @param httpBodyStream The ArkWeb_HttpBodyStream.
 * @param buffer The buffer to receive data.
 ...
 *
 * The buffer must be at least bufLen bytes. We will read data from a worker
 * thread to the buffer,\n so should not use the buffer in other threads before
 * the callback to avoid concurrency issues.\n
 *
 * @param httpBodyStream The ArkWeb_HttpBodyStream.
 * @param buffer The buffer to receive data.
 * @param bufLen The size of bytes to read.
 ...
 * @since 20
 */
void OH_ArkWebHttpBodyStream_AsyncRead(
    const ArkWeb_HttpBodyStream* httpBodyStream,
    uint8_t* buffer,
    int bufLen);
 ...
 * @since 12
 */
uint64_t OH_ArkWebHttpBodyStream_GetSize(
    const ArkWeb_HttpBodyStream* httpBodyStream);
 ...
 * @since 12
 */
uint64_t OH_ArkWebHttpBodyStream_GetPosition(
    const ArkWeb_HttpBodyStream* httpBodyStream);
 ...
 * @since 12
 */
bool OH_ArkWebHttpBodyStream_IsChunked(
    const ArkWeb_HttpBodyStream* httpBodyStream);

/*
 * @brief Returns true if all data has been consumed from this upload data
 ...
 * and all read requests will succeed synchronously. Expected to return false
 ...
 * @since 12
 */
int32_t OH_ArkWebResourceRequest_Destroy(
    const ArkWeb_ResourceRequest* resourceRequest);

/*
 * @brief Get the referrer of request.
 * @param resourceRequest The ArkWeb_ResourceRequest.
 * @param referrer The request's referrer. This function will allocate memory
 * for the referrer string and caller must release the string by
 * OH_ArkWeb_ReleaseString.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
void OH_ArkWebResourceRequest_GetReferrer(
    const ArkWeb_ResourceRequest* resourceRequest,
    char** referrer);
 ...
 * @since 12
 */
bool OH_ArkWebResourceRequest_IsRedirect(
    const ArkWeb_ResourceRequest* resourceRequest);
 ...
 * @since 12
 */
bool OH_ArkWebResourceRequest_IsMainFrame(
    const ArkWeb_ResourceRequest* resourceRequest);
 ...
 * @since 12
 */
bool OH_ArkWebResourceRequest_HasGesture(
    const ArkWeb_ResourceRequest* resourceRequest);

/*
 * @brief Register custom scheme to the ArkWeb. Should not be called for
 * built-in HTTP, HTTPS, FILE, FTP, ABOUT and DATA schemes. This function should
...
/*
 * @brief Set a ArkWeb_SchemeHandler for a specific scheme to intercept requests
 * of that scheme type. SchemeHandler should be set after the BrowserContext
 * created. Use WebviewController.initializeWebEngine to initialize the
 * BrowserContext without create a ArkWeb.
 *
 * @param scheme Scheme that need to be intercepted.
 * @param schemeHandler The SchemeHandler for the scheme. Only requests
 * triggered by ServiceWorker will be notified through this handler.
 * @return Return true if set SchemeHandler for specific scheme successful,
 ...
 * @param schemeHandler The SchemeHandler for the scheme. Only requests
 * triggered from the specified web will be notified through this handler.
 * @return Return true if set SchemeHandler for specific scheme successful,
 * return false otherwise.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
bool OH_ArkWeb_SetSchemeHandler(const char* scheme,
                                const char* webTag,
                                ArkWeb_SchemeHandler* schemeHandler);
 ...
 * @param schemeHandler Return the created SchemeHandler. Use
 * OH_ArkWeb_DestroySchemeHandler destroy it when donn't need it.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
 ...
 * @since 12
 */
int32_t OH_ArkWebSchemeHandler_SetUserData(ArkWeb_SchemeHandler* schemeHandler,
                                           void* userData);
 ...
 * @param Return the created Response. Use OH_ArkWeb_DestroyResponse to destroy
 * when donn't need it.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 ...
 * @since 12
 */
int32_t OH_ArkWebResponse_SetError(ArkWeb_Response* response,
 ...
 * @since 12
 */
int32_t OH_ArkWebResponse_SetStatusText(ArkWeb_Response* response,
                                        const char* statusText);

/*
 * @brief Get the response's status text.
 * @param response The ArkWeb_Response.
 * @param statusText Return the response's statusText. This function will
 * allocate memory for the statusText string and caller must release the string
 * by OH_ArkWeb_ReleaseString.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
void OH_ArkWebResponse_GetStatusText(const ArkWeb_Response* response,
                                     char** statusText);
 ...
 * @since 12
 */
int32_t OH_ArkWebResponse_SetMimeType(ArkWeb_Response* response,
                                      const char* mimeType);

/*
 * @brief Get the response's mime type.
 * @param response The ArkWeb_Response.
 * @param mimeType Return the response's mime type. This function will allocate
 * memory for the mime type string and caller must release the string by
 * OH_ArkWeb_ReleaseString.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
void OH_ArkWebResponse_GetMimeType(const ArkWeb_Response* response,
                                   char** mimeType);
 ...
 * @since 12
 */
int32_t OH_ArkWebResponse_SetCharset(ArkWeb_Response* response,
                                     const char* charset);

/*
 * @brief Get the response's charset.
 * @param response The ArkWeb_Response.
 * @param charset Return the response's charset. This function will allocate
 * memory for the charset string and caller must release the string by
 * OH_ArkWeb_ReleaseString.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
void OH_ArkWebResponse_GetCharset(const ArkWeb_Response* response,
                                  char** charset);
 ...
 * @param response The ArkWeb_Response.
 * @param name The name of the header.
 * @param value Return the header's value. This function will allocate memory
 * for the value string and caller must release the string by
 * OH_ArkWeb_ReleaseString.
 *
 * @syscap SystemCapability.Web.Webview.Core
 * @since 12
 */
void OH_ArkWebResponse_GetHeaderByName(const ArkWeb_Response* response,
                                       const char* name,
                                       char** value);
 ...
 * @since 12
 */
int32_t OH_ArkWebResourceHandler_Destroy(
    const ArkWeb_ResourceHandler* resourceHandler);
...
/*
 * @brief Notify the ArkWeb that this request should be finished and there is no
 * more data available.
 * @param resourceHandler The ArkWeb_ResourceHandler for the request.
 * @return 0 if success; otherwise if fail. refer to arkweb_error_code.h.
 *
 ...
 * @since 12
 */
int32_t OH_ArkWebResourceHandler_DidFinish(
    const ArkWeb_ResourceHandler* resourceHandler);

/*
 * @brief Notify the ArkWeb that this request should be failed.
 * @param resourceHandler The ArkWeb_ResourceHandler for the request.
 * @param errorCode The error code for this request. refer to
