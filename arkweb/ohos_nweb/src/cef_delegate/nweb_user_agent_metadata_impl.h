...
class NWebUserAgentMetadataImpl : public NWebUserAgentMetadata {
 public:
  ...
  NWebUserAgentMetadataImpl(const std::vector<std::string>& brand,
  ...
  void GetBrandVersionList(std::vector<std::string>& brand,
