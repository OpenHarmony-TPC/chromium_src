...
2. Download the full code.
    ...
    repo init -u https://gitee.com/openharmony-sig/manifest -b 4.0-Release -m chromium.xml --no-repo-verify
...
3. Build the code.
    ...
    To build an unsigned HAP file, run **./build.sh -A -without-nweb-ex rk3568**
