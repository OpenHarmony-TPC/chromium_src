...
#ifdef OHOS_NB_DEBUG
  LOG(ERROR)<<__FUNCTION__<<"is_frame_available_callback_set_ true...";
#endif
...
HwVideoNativeBufferGLOwner::GetNativeBuffer() {
...
#ifdef OHOS_NB_DEBUG
  LOG(ERROR)<<__FUNCTION__<<" calling HwVideoNativeBufferGLOwner";
#endif
  ...
  uint32_t seq_num = OHOS::NWeb::OhosAdapterHelper::GetInstance()
                        ...
                        .GetSeqNum(buffer);
  TRACE_EVENT1("gpu", "HwVideoNativeBufferGLOwner::GetNativeBuffer", "seqnum", seq_num);
