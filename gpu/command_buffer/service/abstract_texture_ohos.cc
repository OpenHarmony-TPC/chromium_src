...
AbstractTextureOHOS::CreateForValidating(gfx::Size size) {
...
std::unique_ptr<AbstractTextureOHOS>
AbstractTextureOHOS::CreateForPassthrough(gfx::Size size) {
  GLuint service_id = CreateTextureWithLinearFilter();
...
std::unique_ptr<AbstractTextureOHOS>
AbstractTextureOHOS::CreateForTesting(GLuint texture_id) {
