...
#undef FAIL_INIT_IF_NOT
  ...
  // TEMPORARY: Set promitive restart to enabled by default for WebGL2. Clear
  ...
  if (feature_info_->context_type() == CONTEXT_TYPE_WEBGL2) {
    ...
    // See the section <Primitive Restart is Always Enabled> in WebGL 2spec:
    // http://www.khronos.org/registry/webgl/specs/latest/2.0/#4.1.4
