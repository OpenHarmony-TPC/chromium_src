...
private:
    ...
    static napi_value WrapperForward(napi_env& env, void* invoker, std::true_type, Args&&... args);

    template<typename... Args>
    static napi_value WrapperForward(napi_env& env, void* invoker, std::false_type, Args&&... args);
#else
    template<typename... Args>
