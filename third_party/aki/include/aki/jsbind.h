...
#define JSBIND_EXTEND(__parentName) definer.AddExtendClass(#__parentName)
...
static struct EnumerationDefiner##__enum<__enum> enumerationDefiner##__enum;                           \
template<typename E> EnumerationDefiner##__enum<E>::EnumerationDefiner##__enum():definer(#__enum)

#define JSBIND_ENUM_VALUE(__value) definer.SetValue(#__value, static_cast<int32_t>(E::__value))
