...
void NWebAdsBlockManagerImpl::SetAdsBlockRules(const std::string &rulesFile, bool replace) {
  if (delegate_ != nullptr) {
    delegate_->SetAdsBlockRules(rulesFile, replace);
  }
}

void NWebAdsBlockManagerImpl::AddAdsBlockDisallowedList(const std::vector<std::string> &domainSuffixes) {
  if (delegate_ != nullptr) {
    delegate_->AddAdsBlockDisallowedList(domainSuffixes);
  }
}

void NWebAdsBlockManagerImpl::RemoveAdsBlockDisallowedList(const std::vector<std::string> &domainSuffixes) {
  if (delegate_ != nullptr) {
...
void NWebAdsBlockManagerImpl::AddAdsBlockAllowedList(const std::vector<std::string> &domainSuffixes) {
  if (delegate_ != nullptr) {
    delegate_->AddAdsBlockAllowedList(domainSuffixes);
  }
}

void NWebAdsBlockManagerImpl::RemoveAdsBlockAllowedList(const std::vector<std::string> &domainSuffixes) {
  if (delegate_ != nullptr) {
