...
#ifndef NWEB_FIRST_LARGEST_CONTENTFUL_PAINT_DETAILS_IMPL_H
#define NWEB_FIRST_LARGEST_CONTENTFUL_PAINT_DETAILS_IMPL_H

#include "nweb_largest_contentful_paint_details.h"

namespace OHOS::NWeb {
class NWebLargestContentfulPaintDetailsImpl : public NWebLargestContentfulPaintDetails {
 public:
  NWebLargestContentfulPaintDetailsImpl(int64_t navigationStartTime,
                                        ...
                                        double_t imageBPP);
  ~NWebLargestContentfulPaintDetailsImpl() = default;
...
#endif // NWEB_FIRST_LARGEST_CONTENTFUL_PAINT_DETAILS_IMPL_H