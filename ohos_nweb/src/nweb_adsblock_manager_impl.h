...
#ifndef NWEB_ADSBLOCK_MANAGER_IMPL_H
#define NWEB_ADSBLOCK_MANAGER_IMPL_H
...
namespace OHOS::NWeb {
class NWebAdsBlockManagerImpl : public NWebAdsBlockManager {
 public:
  NWebAdsBlockManagerImpl();
  ~NWebAdsBlockManagerImpl() = default;

  static std::shared_ptr<NWebAdsBlockManager> GetInstance();
 ...
 private:
  std::shared_ptr<NWebAdsBlockManagerDelegateInterface> delegate_;
};
}  // namespace OHOS::NWeb

#endif  // NWEB_ADSBLOCK_MANAGER_IMPL_H
