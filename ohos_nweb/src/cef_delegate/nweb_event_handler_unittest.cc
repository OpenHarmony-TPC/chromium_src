...
class MockCefBrowserHost : public CefBrowserHost {
 public:
  ...
  MOCK_METHOD(void, SendTouchEventList, (const std::vector<CefTouchEvent>&), (override));
  ...
  MOCK_METHOD(void, SendMouseMoveEvent, (const CefMouseEvent&, bool), (override));

  MOCK_METHOD(void, SendMouseWheelEvent, (const CefMouseEvent&, int, int), (override));
