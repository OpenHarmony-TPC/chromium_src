...
typedef void (*OnSrceenCaptureOnStateChange)(int32_t nweb_id, const char* sessionid, int32_t code);
...
NWEB_EXPORT void  WebScreenCapture_PutScreenCaptureCallback(WebScreenCaptureDelegateCallback *callback, int32_t nwebId);
NWEB_EXPORT void  WebScreenCapture_StopScreenCapture(int32_t nweb_id, const char* sessionid);
#ifdef __cplusplus
}
#endif // __cplusplus
